...
-- ----------------------------
INSERT INTO `linkis_datasource_type` VALUES (1, 'mysql', 'mysql数据库', 'mysql数据库', '关系型数据库', 'https://mysqlcdnurl.png', 3);
INSERT INTO `linkis_datasource_type` VALUES (2, 'hive', 'hive数据库', 'hive', '大数据存储', 'https://img.hivecdnurl.png', 3);
INSERT INTO `linkis_datasource_type` VALUES (3, 'presto', 'presto SQL', 'presto', '大数据存储', 'https://prestocdnurl.png', 3);
INSERT INTO `linkis_datasource_type` VALUES (4, 'kafka', 'kafka', 'kafka', '消息队列', 'https://kafkacdnurl.png', 2);
