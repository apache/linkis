...
package com.apache.wedatasphere.linkis.message.conf;
...
public class MessageSchedulerConf {
    ...
    public static final String SERVICE_SCAN_PACKAGE = CommonVars.apply("wds.linkis.ms.service.scan.package", "com.apache.wedatasphere").getValue();
