...
package com.apache.wedatasphere.linkis.server
...
import com.apache.wedatasphere.linkis.server.socket.ControllerServer
import com.apache.wedatasphere.linkis.server.socket.controller.{ServerEventService, ServerListenerEventBus}
...
//    webApp.addFilter(filterHolder, restfulPath, EnumSet.allOf(classOf[DispatcherType]))
 // }
  ...
  def setupSpringRestApiContextHandler(webApp: ServletContextHandler) {
    ...
    //val CONFIG_LOCATION = "com.apache.wedatasphere.linkis.manager.am"
    val CONFIG_LOCATION = ""
