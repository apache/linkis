...
package com.apache.wedatasphere.linkis.server.conf

import java.io.File
import java.lang.Boolean

import com.apache.wedatasphere.linkis.common.conf.{CommonVars, Configuration, TimeType}
import com.apache.wedatasphere.linkis.common.utils.{DESUtil, Logging, Utils}
import com.apache.wedatasphere.linkis.server.exception.BDPInitServerException
...
object ServerConfiguration extends Logging{
  ...
  val BDP_SERVER_SECURITY_FILTER = CommonVars("wds.linkis.server.security.filter", "com.apache.wedatasphere.linkis.server.security.SecurityFilter")
