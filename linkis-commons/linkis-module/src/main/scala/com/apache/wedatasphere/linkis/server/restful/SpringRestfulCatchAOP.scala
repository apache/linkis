...
package com.apache.wedatasphere.linkis.server.restful
...
class SpringRestfulCatchAOP extends Logging {
  ...
  @Pointcut("@annotation(org.springframework.web.bind.annotation.RequestMapping) && execution(public com.apache.wedatasphere.linkis.server.Message *(..)))")
