...
package com.apache.wedatasphere.linkis.storage.fs.impl;
...
import com.apache.wedatasphere.linkis.storage.utils.StorageConfiguration;
...
public class HDFSFileSystem extends FileSystem {
    ...
    private boolean canAccess(FsPath fsPath, FsAction access) throws IOException {
        ...
        try {
            ...
            if ((Boolean) com.apache.wedatasphere.linkis.common.conf.Configuration.IS_TEST_MODE().getValue()) {
