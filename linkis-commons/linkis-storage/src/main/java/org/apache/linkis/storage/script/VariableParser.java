...
public class VariableParser {
    ...
    private static Variable[] createVariableArray(Map<String, Object> variableMap, Map<String, Object> configurationMap) {
    ...
    private static Stream<Variable> createVariableStream(String parentSort, String sort, Object value) {
