...
package com.apache.wedatasphere.linkis.storage.script.writer
...
import com.apache.wedatasphere.linkis.storage.script.{Compaction, ScriptFsWriter, ScriptMetaData}
