...
import com.apache.wedatasphere.linkis.common.conf.{ByteType, CommonVars}
...
object StorageConfiguration {
  ...
  val STORAGE_RESULT_SET_PACKAGE = CommonVars("wds.linkis.storage.result.set.package", "com.apache.wedatasphere.linkis.storage.resultset")
  ...
  val STORAGE_BUILD_FS_CLASSES = CommonVars("wds.linkis.storage.build.fs.classes", "com.apache.wedatasphere.linkis.storage.factory.impl.BuildHDFSFileSystem,com.apache.wedatasphere.linkis.storage.factory.impl.BuildLocalFileSystem")
