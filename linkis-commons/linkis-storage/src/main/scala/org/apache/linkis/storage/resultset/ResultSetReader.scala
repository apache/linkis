...
//  }
//
//  def getResultSetReader(res: String): ResultSetReaderFactory[_ <: MetaData, _ <: Record] = {
...
//  }
//
//  def getTableResultReader(res: String): ResultSetReaderFactory[TableMetaData, TableRecord] = {
//    val rsFactory = ResultSetFactory.getInstance
//    if (rsFactory.isResultSet(res)) {
//      val resultSet = rsFactory.getResultSet(res)
