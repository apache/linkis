...
public class AppKeys {
    ...
    public static final String LINKIS_CLIENT_NONCUSTOMIZABLE_ENABLE_PROXY_USER =
            LINKIS_CLIENT_NONCUSTOMIZABLE
                    + ".enable.proxy.user"; // allow user to specify proxy user
    ...
    public static final String LINKIS_CLIENT_DEFAULT_CONFIG =
            LINKIS_CLIENT_COMMON + ".default.conf";
    ...
    public static final String JOB_COMMON_SUBMIT_PASSWORD =
            LINKIS_CLIENT_COMMON + ".submitPassword";
    ...
    public static final String UJESCLIENT_COMMON_READTIMEOUT =
            LINKIS_CLIENT_COMMON + ".readTimeout";
