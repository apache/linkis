...
public class AppKeys {
   ...
   */
    ...
    public static final String JOB_LABEL_EXECUTEONCE = JOB_LABEL + "." + LinkisKeys.KEY_EXECUTEONCE; //corresponds to server api.
    ...
    public static final String LINKIS_COMMON_DIAPLAY_META_LOGO = LINKIS_CLIENT_COMMON + ".display.meta.log";
    ...
    public static final String JOB_EXTRA_ARGUMENTS = LINKIS_CLIENT_COMMON + "." + LinkisKeys.EXTRA_ARGUMENTS;
    ...
    public static final String LINKIS_CLIENT_COMMON_RESULT_SET_PAGE_SIZE = LINKIS_CLIENT_COMMON + ".resultset.page.size";
