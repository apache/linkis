...
public interface DriverTransformer {
    ...
    JobExec convertAndUpdateExecData(JobExec execData, DWSResult result)
            throws LinkisClientRuntimeException;

    JobExecModel convertAndUpdateModel(JobExecModel model, DWSResult result)
            throws LinkisClientRuntimeException;

    List<LinkedHashMap<String, String>> convertResultMeta(Object rawMetaData)
            throws LinkisClientRuntimeException;
