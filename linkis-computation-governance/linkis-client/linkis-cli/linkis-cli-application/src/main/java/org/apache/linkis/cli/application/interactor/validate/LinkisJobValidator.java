    ...
    public void doValidation(Object input) throws LinkisClientRuntimeException {
        if (!(input instanceof LinkisJob || input instanceof LinkisJobMan)) {
            throw new ValidateException(
                    ...
                    "Input of LinkisJobValidator is not instance of LinkisJob nor LinkisJobMan. Type: "
        ...
        if (input instanceof LinkisJobMan) {
            ...
            if (StringUtils.isBlank(linkisJob.getSubmitUser())) {
                reasonSb.append("Submit User cannot be empty or blank")
            ...
            if (StringUtils.isBlank(
                    (String) linkisJob.getLabelMap().get(LinkisKeys.KEY_ENGINETYPE))) {
            ...
            if (StringUtils.isBlank(
                    (String) linkisJob.getLabelMap().get(LinkisKeys.KEY_CODETYPE))) {
            ...
            if (StringUtils.isBlank(
                    (String) linkisJob.getSourceMap().get(LinkisKeys.KEY_SCRIPT_PATH))) {
            ...
            if (StringUtils.isBlank(
                    (String) linkisJob.getLabelMap().get(LinkisKeys.KEY_USER_CREATOR))) {
                ...
                if (idx == -1) {
                    reasonSb.append(LinkisKeys.KEY_USER_CREATOR)
                            .append("should contains exactly one \'-\'")
                            .append(System.lineSeparator());
                    ok = false;
                } else {
                    ...
                    if (StringUtils.isBlank(user) || StringUtils.isBlank(creator)) {
                        ...
                        if (StringUtils.containsAny(user, forBiddenChars)) {
                            reasonSb.append(LinkisKeys.KEY_USER_CREATOR)
                                    .append(
                                            "should contains exactly one \'-\' and no special characters except \'_\'")
                                    .append(System.lineSeparator());
                            ok = false;
                        }
