...
public class UJESResultAdapter implements LinkisOperResultAdapter {
    ...
    public UJESResultAdapter(Object result) {
        if (!(result instanceof DWSResult) && !(result instanceof UJESResult)) {
            throw new TransformerException("TFM0001", ErrorLevel.ERROR, CommonErrMsg.TransformerException, "Input of UJESResultAdapter is not of correct type. Current type:" + result.getClass().getCanonicalName());
        }
        this.result = result;
    }
    ...
    public String getProxyUser() {
        ...
        if (result instanceof JobInfoResult) {
            ...
            if (result != null &&
                ...
                requestApplication = parseUserOutOfExecId((String) ((JobInfoResult) result).getTask().get(LinkisKeys.KEY_REQUESTAPP), requestApplication);
            }
            if (result != null &&
                    ((JobInfoResult) result).getData() != null &&
                    ((JobInfoResult) result).getData().containsKey(LinkisKeys.KEY_EXECID)) {
                parsedUser1 = parseUserOutOfExecId((String) ((JobInfoResult) result).getData().get(LinkisKeys.KEY_EXECID), requestApplication);
            }
            if (result != null &&
                    ((JobInfoResult) result).getTask() != null &&
                    ((JobInfoResult) result).getTask().containsKey(LinkisKeys.KEY_STRONGER_EXECID)) {
                parsedUser2 = parseUserOutOfStrongerExecId((String) ((JobInfoResult) result).getTask().get(LinkisKeys.KEY_STRONGER_EXECID), requestApplication);
            }
    ...
    public String getLogPath() {
        ...
        if (result instanceof JobInfoResult) {
            if (((JobInfoResult) result).getRequestPersistTask() != null &&
                    StringUtils.isNotBlank(((JobInfoResult) result).getRequestPersistTask().getLogPath())) {
    ...
    public String getResultLocation() {
        ...
        if (result instanceof JobInfoResult) {
            if (((JobInfoResult) result).getRequestPersistTask() != null &&
                    ...
                    StringUtils.isNotBlank(((JobInfoResult) result).getRequestPersistTask().getResultLocation())) {
                String resultLocation = ((JobInfoResult) result).getRequestPersistTask().getResultLocation();
    ...
    public Integer getErrCode() {
        ...
        if (result instanceof JobInfoResult) {
            if (((JobInfoResult) result).getTask() != null &&
                ...
                Integer errCode = (Integer) ((JobInfoResult) result).getTask().get(LinkisKeys.KEY_ERROR_CODE);
                return errCode;
            }
        }
        return null;
    ...
    public Integer getNextLogLine() {
        ...
        if (result instanceof OpenLogResult2 &&
            ...
            return OperatorUtils.getNumOfLines(((OpenLogResult2) result).getResult().getLog()[UJESConstants.IDX_FOR_LOG_TYPE_ALL]);
        }
        return null;
    }
    ...
    public LinkisResultSet getResultContent() {
        ...
        if (result instanceof ResultSetResult2 &&
            ...
            if (((ResultSetResult2) result).getResultSetResult().getMetadata() != null) {
                ret.setResultMeta(this.convertResultMeta(((ResultSetResult2) result).getResultSetResult().getMetadata()));
            }
            if (((ResultSetResult2) result).getResultSetResult().getFileContent() != null) {
                ret.setContent(this.convertRawResultContent(((ResultSetResult2) result).getResultSetResult().getFileContent()));
            }
    ...
    public Boolean resultHasNextPage() {
        ...
        if (result instanceof ResultSetResult2) {
            if (((ResultSetResult2) result).getResultSetResult() == null ||
                    ((ResultSetResult2) result).getResultSetResult().getFileContent() == null ||
                    (((ResultSetResult2) result).getResultSetResult().getFileContent() instanceof List && ((List<?>) ((ResultSetResult2) result).getResultSetResult().getFileContent()).size() == 0) ||
    ...
    public String getUmUser() {
        ...
        if (result instanceof JobInfoResult && ((JobInfoResult) result).getRequestPersistTask() != null) {
    ...
    public String getEngineType() {
        ...
        if (result instanceof JobInfoResult && ((JobInfoResult) result).getTask() != null &&
