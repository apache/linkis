...
/**
 * CmdTemplate defines what CmdOption/Flag/Parameter that a command should contains.
...
public abstract class AbstractCmdTemplate implements CmdTemplate, Cloneable {
    ...
    protected final StdOption<Boolean> option(String keyPrefix, String key, String[] paramName, String description, boolean isOptional,
                                              Boolean defaultValue) {
        return option(keyPrefix, key, paramName, description, isOptional, defaultValue, PredefinedStringConverters.BOOLEAN_CONVERTER);
    }
