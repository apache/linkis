...
/**
 * Backend support job-management, e.g. get status, get log, kill job etc. Then implement this interface.
 */
public interface ManagableBackendJob extends Job {
     ...
     * implementation should use {@link JobSubType}
     * to decide which action to take, hence {@link JobSubType}
     * should not be null
     */
    void doManage() throws LinkisClientRuntimeException;

    /**
     * if execution is success.
     * This can be different from {@link JobStatus}
     * e.g. query job status, job may be FAIL but execution is a asuccess
     */
    boolean isSuccess();
}
