...
public class TestSparkCmdTemplate extends AbstractCmdTemplate {
  ...
  protected StdOption<String> userOp =
      option(
          null, TestConstants.PARAM_USER, new String[] {"-u", "--user"}, "specify user", true, "");
  ...
  private StdOption<String> otherPara =
      option(
          null,
  ...
  private StdOption<String> runTypePara =
      option(
          null,
          TestConstants.PARAM_SPARK_RUNTYPE,
          new String[] {"--runtype"},
          "specify the runtype parameters: sql pyspark scala",
          true,
          "sql");
  ...
  private Map<String, String> parseOtherMap(String otherStr) {
    ...
    /**
     * split by space-chara, but if space char is within \"\", then do not split. e.g. "a b c" will
     * not be splited
     */
