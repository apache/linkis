...
import com.apache.wedatasphere.linkis.computation.client.operator.{Operator, OperatorFactory}
import com.apache.wedatasphere.linkis.computation.client.{JobListener, LinkisJob, LinkisJobBuilder}
...
trait AbstractLinkisJob extends LinkisJob with Logging {
  ...
  private val operatorActions: ArrayBuffer[Operator[_] => Operator[_]] = new ArrayBuffer[Operator[_] => Operator[_]]()
