 ...
 */
package com.apache.wedatasphere.linkis.computation.client.once

import java.io.Closeable

import com.apache.wedatasphere.linkis.computation.client.once.action.{CreateEngineConnAction, GetEngineConnAction, KillEngineConnAction, LinkisManagerAction}
import com.apache.wedatasphere.linkis.computation.client.once.result.{CreateEngineConnResult, GetEngineConnResult, KillEngineConnResult, LinkisManagerResult}
