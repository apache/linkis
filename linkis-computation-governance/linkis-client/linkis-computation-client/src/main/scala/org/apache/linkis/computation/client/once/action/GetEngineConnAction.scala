...
object GetEngineConnAction {
  ...
  class Builder private[GetEngineConnAction] ()
      extends ServiceInstanceBuilder[GetEngineConnAction] {

    override protected def createGetEngineConnAction(): GetEngineConnAction =
