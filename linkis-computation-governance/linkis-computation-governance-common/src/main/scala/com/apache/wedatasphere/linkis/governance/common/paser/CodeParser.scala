...
package com.apache.wedatasphere.linkis.governance.common.paser
...
import com.apache.wedatasphere.linkis.governance.common.paser.CodeType.CodeType
...
class SQLCodeParser extends SingleCodeParser {
  ...
  def isSelectCmdNoLimit(cmd: String): Boolean = {
    ...
    /**
     * com.apache.wedatasphere.linkis.entrance.interceptor.impl.Explain has convert and check the limit for code,
