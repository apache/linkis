package com.apache.wedatasphere.linkis.governance.common.protocol.job

import java.util

import com.apache.wedatasphere.linkis.governance.common.entity.job.{SubJobDetail, SubJobInfo}
