...
import org.apache.linkis.engineconn.core.creation.{
  AbstractCodeLanguageLabelExecutorFactory,
...
trait ComputationSingleExecutorEngineConnFactory
    ...
    with AbstractCodeLanguageLabelExecutorFactory
    with AbstractExecutorFactory {

  protected override def newExecutor(
      id: Int,
