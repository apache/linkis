...
package com.apache.wedatasphere.linkis.engineconn.common.conf
...
object EngineConnConf {
  ...
  val ENGINE_EXECUTIONS = CommonVars("wds.linkis.engine.connector.executions", "com.apache.wedatasphere.linkis.engineconn.computation.executor.execute.ComputationEngineConnExecution")

  val ENGINE_CONN_HOOKS = CommonVars("wds.linkis.engine.connector.hooks", "com.apache.wedatasphere.linkis.engineconn.computation.executor.hook.ComputationEngineConnHook")
  ...
  val ENGINE_CONN_PLUGIN_CLAZZ = CommonVars("wds.linkis.engineconn.plugin.default.class", "com.apache.wedatasphere.linkis.engineplugin.hive.HiveEngineConnPlugin")
