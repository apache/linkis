...
object EngineConnConf {
  ...
  val ENGINE_EXECUTIONS = CommonVars("wds.linkis.engine.connector.executions", "org.apache.linkis.engineconn.computation.executor.execute.ComputationEngineConnExecution")

  val ENGINE_CONN_HOOKS = CommonVars("wds.linkis.engine.connector.hooks", "org.apache.linkis.engineconn.computation.executor.hook.ComputationEngineConnHook")
  ...
  val ENGINE_CONN_PLUGIN_CLAZZ = CommonVars("wds.linkis.engineconn.plugin.default.class", "org.apache.linkis.engineplugin.hive.HiveEngineConnPlugin")
