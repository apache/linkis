...
package com.apache.wedatasphere.linkis.engineconn.executor.conf
...
object EngineConnExecutorConfiguration {
  ...
  val EXECUTOR_MANAGER_SERVICE_CLAZZ = CommonVars("wds.linkis.engineconn.executor.manager.service.class", "com.apache.wedatasphere.linkis.engineconn.acessible.executor.service.DefaultManagerService")

  val EXECUTOR_MANAGER_CLASS = CommonVars("wds.linkis.engineconn.executor.manager.class", "com.apache.wedatasphere.linkis.engineconn.core.executor.LabelExecutorManagerImpl")
