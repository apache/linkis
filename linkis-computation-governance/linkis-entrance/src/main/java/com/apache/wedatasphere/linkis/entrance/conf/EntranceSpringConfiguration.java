...
package com.apache.wedatasphere.linkis.entrance.conf;

import com.apache.wedatasphere.linkis.entrance.EntranceParser;
import com.apache.wedatasphere.linkis.entrance.annotation.*;
import com.apache.wedatasphere.linkis.entrance.event.*;
import com.apache.wedatasphere.linkis.entrance.execute.impl.EntranceExecutorManagerImpl;
import com.apache.wedatasphere.linkis.entrance.interceptor.EntranceInterceptor;
import com.apache.wedatasphere.linkis.entrance.interceptor.OnceJobInterceptor;
import com.apache.wedatasphere.linkis.entrance.interceptor.impl.*;
import com.apache.wedatasphere.linkis.entrance.log.*;
import com.apache.wedatasphere.linkis.entrance.parser.CommonEntranceParser;
import com.apache.wedatasphere.linkis.entrance.persistence.*;
import com.apache.wedatasphere.linkis.entrance.scheduler.EntranceGroupFactory;
import com.apache.wedatasphere.linkis.entrance.scheduler.EntranceSchedulerContext;
import com.apache.wedatasphere.linkis.orchestrator.ecm.EngineConnManagerBuilder;
import com.apache.wedatasphere.linkis.orchestrator.ecm.EngineConnManagerBuilder$;
import com.apache.wedatasphere.linkis.orchestrator.ecm.entity.Policy;
import com.apache.wedatasphere.linkis.scheduler.Scheduler;
import com.apache.wedatasphere.linkis.scheduler.SchedulerContext;
import com.apache.wedatasphere.linkis.scheduler.executer.ExecutorManager;
import com.apache.wedatasphere.linkis.scheduler.queue.ConsumerManager;
import com.apache.wedatasphere.linkis.scheduler.queue.GroupFactory;
import com.apache.wedatasphere.linkis.scheduler.queue.parallelqueue.ParallelConsumerManager;
import com.apache.wedatasphere.linkis.scheduler.queue.parallelqueue.ParallelScheduler;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.boot.autoconfigure.condition.ConditionalOnMissingBean;
import org.springframework.context.annotation.Configuration;

import static com.apache.wedatasphere.linkis.entrance.conf.EntranceConfiguration.ENTRANCE_SCHEDULER_MAX_PARALLELISM_USERS;
...
public class EntranceSpringConfiguration {
    ...
    public ErrorCodeManager generateErrorCodeManager() {
        try {
            Class.forName("com.apache.wedatasphere.linkis.errorcode.client.handler.LinkisErrorCodeHandler");
