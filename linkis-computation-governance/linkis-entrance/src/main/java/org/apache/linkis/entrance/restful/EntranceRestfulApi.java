...
public class EntranceRestfulApi implements EntranceRestfulRemote {
     ...
     */
    @ApiOperation(value="处理任务请求",notes="execute函数处理的是用户提交执行任务的请求",response = MessageJava.class)
    @Override
    ...
    @ApiOperation(value="任务进展",notes="任务进展",response = MessageJava.class)
    @ApiImplicitParams({
    ...
    @ApiOperation(value="任务日志",notes="获取任务日志",response = MessageJava.class)
    @ApiImplicitParams({
            @ApiImplicitParam(name="id",dataType="String",value="任务ID")
    })
    @Override
    ...
    @ApiOperation(value="暂停任务",notes="暂停任务",response = MessageJava.class)
    @ApiImplicitParams({
            @ApiImplicitParam(name="id",dataType="String",value="任务ID")
    })
    @Override
