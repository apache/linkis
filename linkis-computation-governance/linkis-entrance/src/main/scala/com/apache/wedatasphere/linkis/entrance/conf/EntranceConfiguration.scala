...
import com.apache.wedatasphere.linkis.common.conf.{CommonVars, TimeType}
...
object EntranceConfiguration {
  ...
  val LOG_WARN_EXCLUDE = CommonVars("wds.linkis.warn.log.exclude", "org.apache,hive.ql,hive.metastore,com.netflix,com.apache.wedatasphere")
  ...
  /**
    ...
    */
  val LOG_EXCLUDE = CommonVars("wds.linkis.log.exclude", "org.apache,hive.ql,hive.metastore,com.netflix,com.apache.wedatasphere,com.webank")
  ...
  val SPARK_SPECIAL_LOG_INCLUDE = CommonVars("wds.linkis.spark.special.log.include", "com.apache.wedatasphere.linkis.engine.spark.utils.JobProgressUtil")


  val SPARK_PROGRESS_NAME = CommonVars("wds.linkis.spark.progress.name", "com.apache.wedatasphere.linkis.engine.spark.utils.JobProgressUtil$")
