...
import org.apache.linkis.entrance.ecm.entity.Mark
...
class CodeExecTaskExecutor(engineConnExecutor: EngineConnExecutor, execTask: ExecTask, mark: Mark) {
  ...
  override def toString: String =
    s"engineConn $engineConnExecutor execTask ${execTask.getIDInfo()} mark ${mark.getMarkId()} engineConnTaskId $engineConnTaskId"
