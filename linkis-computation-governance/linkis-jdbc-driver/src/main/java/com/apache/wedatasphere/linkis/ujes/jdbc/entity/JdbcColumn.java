...
package com.apache.wedatasphere.linkis.ujes.jdbc.entity;

import com.apache.wedatasphere.linkis.ujes.jdbc.UJESSQLTypeParser;
...
public class JdbcColumn {
    ...
    public Integer getColumnSize() throws SQLException {
        int precision = columnPrecision(UJESSQLTypeParser.parserFromName(type));

        return precision == 0 ? null : precision;
    }

    public Integer getDecimalDigits() throws SQLException {
        return columnScale(UJESSQLTypeParser.parserFromName(type));
    }
