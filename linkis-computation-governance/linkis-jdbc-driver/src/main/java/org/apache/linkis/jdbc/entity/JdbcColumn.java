...
package org.apache.linkis.jdbc.entity;

import org.apache.linkis.jdbc.LinkisSQLTypeParser;
...
public class JdbcColumn {
  ...
  public Integer getSqlType() throws SQLException {
    return LinkisSQLTypeParser.parserFromName(type);
  }

  public Integer getColumnSize() throws SQLException {
    int precision = columnPrecision(LinkisSQLTypeParser.parserFromName(type));

    return precision == 0 ? null : precision;
  }

  public Integer getDecimalDigits() throws SQLException {
    return columnScale(LinkisSQLTypeParser.parserFromName(type));
  }
