 ...
 */
package com.apache.wedatasphere.linkis.ujes.jdbc.hook
...
object JDBCDriverPreExecutionHook extends Logging{
  ...
  private val preExecutionHooks:Array[JDBCDriverPreExecutionHook] = {
    ...
    CommonVars("wds.linkis.jdbc.pre.hook.class", "com.apache.wedatasphere.linkis.ujes.jdbc.hook.impl.TableauPreExecutionHook").getValue.split(",") foreach {
