...
package org.apache.linkis.jdbc.hook.impl

import org.apache.linkis.jdbc.LinkisSQLDriverMain
...
class NoLimitExecutionHook extends JDBCDriverPreExecutionHook {
  ...
  override def callPreExecutionHook(sql: String): String = {
    if (LinkisSQLDriverMain.LIMIT_ENABLED.toLowerCase.equals("false")) {
