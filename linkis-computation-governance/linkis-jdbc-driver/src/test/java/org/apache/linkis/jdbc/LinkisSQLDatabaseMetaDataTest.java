...
public class LinkisSQLDatabaseMetaDataTest {
  private static LinkisSQLConnection conn;
  private static LinkisSQLDatabaseMetaData dbmd;

  @BeforeClass
  public static void preWork() {
    try {
      conn = CreateConnection.getConnection();
      dbmd = (LinkisSQLDatabaseMetaData) conn.getMetaData();
  ...
  @Test(expected = LinkisSQLException.class)
  ...
  public void getDriverVersion() {
    assertEquals(dbmd.getDriverVersion(), String.valueOf(LinkisSQLDriverMain.DEFAULT_VERSION()));
  }
