...
public class LinkisSQLPreparedStatementTest {
  ...
  public void crud() {
    ...
    LinkisSQLResultSet resultSet = preStatement.getResultSet();
  ...
  public void selectTest() {
    ...
    LinkisSQLResultSet resultSet = preStatement.executeQuery();
    showResult(resultSet);
    Assert.assertTrue(resultSet.isAfterLast());
  }

  private void showResult(LinkisSQLResultSet resultSet) {
    while (resultSet.next()) {
      LinkisSQLResultSetMetaData metaData = resultSet.getMetaData();
  ...
  public void executeQuery() {
    preStatement = conn.prepareStatement("show tables");
    Assert.assertTrue(preStatement.executeQuery() instanceof LinkisSQLResultSet);
  }
}
