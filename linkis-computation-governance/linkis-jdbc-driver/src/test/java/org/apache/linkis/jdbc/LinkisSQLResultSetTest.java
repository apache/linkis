...
public class LinkisSQLResultSetTest {

  private static LinkisSQLConnection conn;
  private LinkisSQLPreparedStatement preStatement;
  private LinkisSQLResultSet resultSet;
  private LinkisSQLResultSetMetaData metaData;
  ...
  public void getObject() {
    while (resultSet.next()) {
      ...
      int columnTypeFromVal = LinkisSQLTypeParser.parserFromVal(resultSet.getObject(1));
