...
public class LinkisSQLStatementTest {
  ...
  public void executeQuery() {
    LinkisSQLResultSet resultSet = statement.executeQuery(sql);
  ...
  public void crud() {
    ...
    LinkisSQLResultSet resultSet = statement.executeQuery(sqlSelect);
    int columnCount = 0;
    while (resultSet.next()) {
      LinkisSQLResultSetMetaData rsmd = resultSet.getMetaData();
