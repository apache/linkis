...
import com.apache.wedatasphere.linkis.manager.label.builder.LabelBuilder;
...
public interface LabelBuilderFactory {
     ...
     * @return label
     */
    <T extends Label<?>> T createLabel(String inLabelKey, Object inValueObj, Class<?> outLabelClass, Type... outValueTypes);
     ...
     * @return label
     */
    <T extends Label<?>> T createLabel(String inLabelKey, InputStream inValueStream, Class<?> outLabelClass, Type... outValueTypes);

    <T extends Label<?>> T createLabel(String inLabelKey, InputStream inValueStream, Class<T> outLabelClass);
     ...
     * @return
     */
    <T extends Label<?>> List<T> getLabels(Map<String, Object> inMap, Class<?> outLabelClass, Type... outValueTypes);
     ...
     * @return
     */
    <T extends Label<?>> T convertLabel(Label<?> sourceLabel, Class<?> targetLabelClass, Type... targetValueTypes);
