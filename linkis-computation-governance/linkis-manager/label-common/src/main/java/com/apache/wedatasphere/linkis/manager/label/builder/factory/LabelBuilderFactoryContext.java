...
public class LabelBuilderFactoryContext {
    ...
    /**
     * init register label builder to com.apache.wedatasphere.linkis.entrance.factory
     *
     * @param labelBuilderFactory
     */
    private static void labelBuilderInitRegister(LabelBuilderFactory labelBuilderFactory) {
        Reflections reflections = com.apache.wedatasphere.linkis.common.utils.ClassUtils.reflections();
