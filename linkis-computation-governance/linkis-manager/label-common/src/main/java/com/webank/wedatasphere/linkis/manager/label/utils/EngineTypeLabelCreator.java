        ...
        if (null == defaultVersion) {
            synchronized (EngineTypeLabelCreator.class) {
                if (null == defaultVersion) {
                    ...
                    defaultVersion.put(EngineType.SQOOP().toString(), LabelCommonConfig.SQOOP_ENGINE_VERSION.getValue());
                    defaultVersion.put(EngineType.DISTCP().toString(), LabelCommonConfig.DISTCP_ENGINE_VERSION.getValue());
                    defaultVersion.put("*", "*");
                }
            }
        }
