...
public class DefaultNodePointerBuilder implements NodePointerBuilder {
  @Override
  public EMNodPointer buildEMNodePointer(EMNode node) {
    return new DefaultEMNodPointer(node);
  }

  @Override
  public EngineNodePointer buildEngineNodePointer(EngineNode node) {
    return new DefaultEngineNodPointer(node);
  }
}
