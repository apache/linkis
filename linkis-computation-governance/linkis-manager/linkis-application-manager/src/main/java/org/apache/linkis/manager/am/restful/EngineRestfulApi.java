...
public class EngineRestfulApi {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name="serviceInstance",required = false,dataType="Map",value="入参属于‘’em"),
            @ApiImplicitParam(name="applicationName",required = false,dataType="String",value="引擎标签名称，属于serviceInstance中的值"),
            @ApiImplicitParam(name="instance",required = false,dataType="String",value="实例名称"),
            @ApiImplicitParam(name="emInstance",required = false,dataType="String",value="引擎实例名称跟‘em’一个级别属于最外层"),
            @ApiImplicitParam(name="engineType",required = false,dataType="String",value="引擎类型跟‘em’一个级别属于最外层"),
            @ApiImplicitParam(name="nodeStatus",required = false,dataType="String",value="状态跟‘em’一个级别属于最外层,状态有以下枚举类型 ‘Healthy‘, ‘UnHealthy‘, ‘WARN‘, ’StockAvailable’, ‘StockUnavailable’"),
            @ApiImplicitParam(name="owner",required = false,dataType="String",value="创建者跟‘em’一个级别属于最外层"),
    })
    @ApiOperationSupport(ignoreParameters = {"jsonNode"})
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name="applicationName",required = false,dataType="String",value="引擎标签"),
            @ApiImplicitParam(name="emStatus",dataType="String",required = false,value = "运行状态",example = "‘Starting’,‘Unlock’,'Locked','Idle','Busy','Running','ShuttingDown','Failed','Success' "),
            @ApiImplicitParam(name="instance",dataType="String",required = false,value="引擎实例名称"),
            @ApiImplicitParam(name="labels",dataType="List",required = false,value="引擎实例更新参数内容，集合存放的是map类型的"),
            @ApiImplicitParam(name="labelKey",dataType="String",required = false,value="添加内容里面的标签，属于labels集合 内 map里的key"),
            @ApiImplicitParam(name="stringValue",dataType="String",required = false,value="添加内容里面的标签对于的值，属于labels集合 内 map里的value")
    })
    @ApiOperationSupport(ignoreParameters = {"jsonNode"})
