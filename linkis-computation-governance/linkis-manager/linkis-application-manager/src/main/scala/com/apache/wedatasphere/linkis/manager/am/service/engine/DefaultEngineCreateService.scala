 ...
 *
 */
package com.apache.wedatasphere.linkis.manager.am.service.engine
...
import com.apache.wedatasphere.linkis.common.utils.{ByteTimeUtils, Logging, Utils}
import com.apache.wedatasphere.linkis.governance.common.conf.GovernanceCommonConf
import com.apache.wedatasphere.linkis.governance.common.conf.GovernanceCommonConf.ENGINE_CONN_MANAGER_SPRING_NAME
import com.apache.wedatasphere.linkis.manager.am.conf.{AMConfiguration, EngineConnConfigurationService}
import com.apache.wedatasphere.linkis.manager.am.exception.{AMErrorCode, AMErrorException}
import com.apache.wedatasphere.linkis.manager.am.label.EngineReuseLabelChooser
import com.apache.wedatasphere.linkis.manager.am.pointer.EngineConnPluginPointer
import com.apache.wedatasphere.linkis.manager.am.selector.NodeSelector
import com.apache.wedatasphere.linkis.manager.common.constant.AMConstant
import com.apache.wedatasphere.linkis.manager.common.entity.enumeration.NodeStatus
import com.apache.wedatasphere.linkis.manager.common.entity.node.{EMNode, EngineNode}
import com.apache.wedatasphere.linkis.manager.common.entity.resource.NodeResource
import com.apache.wedatasphere.linkis.manager.common.protocol.engine.{EngineCreateRequest, EngineStopRequest}
import com.apache.wedatasphere.linkis.manager.common.utils.ManagerUtils
import com.apache.wedatasphere.linkis.manager.engineplugin.common.launch.entity.{EngineConnBuildRequestImpl, EngineConnCreationDescImpl}
import com.apache.wedatasphere.linkis.manager.engineplugin.common.resource.TimeoutEngineResourceRequest
import com.apache.wedatasphere.linkis.manager.label.builder.factory.LabelBuilderFactoryContext
import com.apache.wedatasphere.linkis.manager.label.entity.engine.{EngineInstanceLabel, EngineTypeLabel}
import com.apache.wedatasphere.linkis.manager.label.entity.node.AliasServiceInstanceLabel
import com.apache.wedatasphere.linkis.manager.label.entity.{EngineNodeLabel, Label}
import com.apache.wedatasphere.linkis.manager.label.service.{NodeLabelService, UserLabelService}
import com.apache.wedatasphere.linkis.manager.label.utils.LabelUtils
import com.apache.wedatasphere.linkis.manager.persistence.{NodeMetricManagerPersistence, ResourceManagerPersistence}
import com.apache.wedatasphere.linkis.manager.service.common.label.{LabelChecker, LabelFilter}
import com.apache.wedatasphere.linkis.message.annotation.Receiver
import com.apache.wedatasphere.linkis.message.builder.ServiceMethodContext
import com.apache.wedatasphere.linkis.resourcemanager.service.ResourceManager
import com.apache.wedatasphere.linkis.resourcemanager.{AvailableResource, NotEnoughResource}
import com.apache.wedatasphere.linkis.server.BDPJettyServerHelper
