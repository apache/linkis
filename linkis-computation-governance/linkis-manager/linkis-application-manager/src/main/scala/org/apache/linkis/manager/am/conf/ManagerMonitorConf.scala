...
object ManagerMonitorConf {
  ...
  val NODE_MAX_CREATE_TIME = CommonVars("wds.linkis.manager.am.node.create.time", new TimeType("12m"))

  val NODE_HEARTBEAT_MAX_UPDATE_TIME = CommonVars("wds.linkis.manager.am.node.heartbeat", new TimeType("12m"))
