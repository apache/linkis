...
public enum ManagerCommonErrorCodeSummary {
  ...
  OPERATION_MULTIPLIED(
      11002,
      "Unsupported operation: multiplied(不支持的操作：成倍增加)",
      "Unsupported operation: multiplied(不支持的操作：成倍增加)"),
  NOT_RESOURCE_POLICY(
      11003,
  ...
  NO_RESOURCE_AVAILABLE(
      11201,
      "No resource available found for em(没有为他们找到可用的资源)",
      "No resource available found for em(没有为他们找到可用的资源)"),
  ...
  REFUSE_REQUEST(
      110022,
      "Resource label: {} has no usedResource, please check, refuse request usedResource(资源标签：{}没有usedResource，请检查，拒绝请求usedResource)",
      "Resource label: {} has no usedResource, please check, refuse request usedResource(资源标签：{}没有usedResource，请检查，拒绝请求usedResource)"),
