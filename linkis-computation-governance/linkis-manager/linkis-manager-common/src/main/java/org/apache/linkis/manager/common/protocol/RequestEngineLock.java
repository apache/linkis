...
public class RequestEngineLock implements EngineLock {
  ...
  private EngineLockType lockType = EngineLockType.Timed;

  public RequestEngineLock() {}

  public RequestEngineLock(long timeout, EngineLockType lockType) {
  ...
  public void setLockType(EngineLockType lockType) {
    this.lockType = lockType;
  }
}
