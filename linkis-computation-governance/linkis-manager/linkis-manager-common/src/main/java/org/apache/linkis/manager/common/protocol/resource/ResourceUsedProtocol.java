...
public class ResourceUsedProtocol implements RequestProtocol {
  ...
  public ResourceUsedProtocol(ServiceInstance serviceInstance, NodeResource engineResource) {
    this(serviceInstance, engineResource, null);
  }

  public ResourceUsedProtocol(
      ServiceInstance serviceInstance, NodeResource engineResource, String ticketId) {
