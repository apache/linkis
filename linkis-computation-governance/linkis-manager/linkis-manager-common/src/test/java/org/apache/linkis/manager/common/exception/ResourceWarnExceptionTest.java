...
public class ResourceWarnExceptionTest {
  ...
  public void testResourceWarnException() throws Exception {
    ...
    ResourceWarnException warnException2 =
        new ResourceWarnException(3, "test", "127.0.0.1", 1234, "serviceKind");
  ...
  public void testRMErrorException() throws Exception {
    ...
    RMErrorException rmErrorException1 = new RMErrorException(110013, msg, new RuntimeException());
    assertEquals(110013, rmErrorException1.getErrCode());
    assertEquals(msg, rmErrorException1.getDesc());

    RMErrorException warnException2 =
        new RMErrorException(3, "test", "127.0.0.1", 1234, "serviceKind");
  ...
  public void testRMFatalException() throws Exception {
    ...
    RMFatalException rmFatalException1 =
        new RMFatalException(3, "test", "127.0.0.1", 1234, "serviceKind");
  ...
  public void testRMWarnException() throws Exception {
    ...
    RMWarnException rmWarnException1 =
        new RMWarnException(3, "test", "127.0.0.1", 1234, "serviceKind");
