...
public interface LabelManagerMapper {
    ...
    List<Map<String, Object>> getNodeRelationsByLabels(@Param("labels") List<PersistenceLabel> labels);
    ...
    List<PersistenceLabelRel> listLabelBySQLPattern(@Param("pattern") String pattern, @Param("labelKey") String labelKey);
}
