...
public class ECResourceRecordMapperTest extends BaseDaoTest {
    ...
    public void testGetECResourceInfoHistory(){
        ...
        List<ECResourceInfoRecord> history = ecResourceRecordMapper.getECResourceInfoHistory(username, null, null, null, null);
        assertEquals(1, history.size());
        history = ecResourceRecordMapper.getECResourceInfoHistory(username, null, null, null, enginType);
        assertEquals(1, history.size());
        history = ecResourceRecordMapper.getECResourceInfoHistory(username, "test", null, null, enginType);
