...
public class LabelMapagerMapperTest extends BaseDaoTest {
  ...
  void testGetResourcesByLabel() {
    List<PersistenceResource> resources =
        labelManagerMapper.getResourcesByLabel(labelKey, labelValue);
  ...
  void testGetResourcesByLabels() {
    ...
    List<PersistenceResource> resourcesByLabels =
        labelManagerMapper.getResourcesByLabels(Arrays.asList(pl));
  ...
  void testGetLabelsByLabelIds() {
    ...
    List<PersistenceLabel> labels =
        labelManagerMapper.getLabelsByLabelIds(Arrays.asList(pl.getId(), 1, 2));
    assertEquals(labels.size(), 1);
  }
