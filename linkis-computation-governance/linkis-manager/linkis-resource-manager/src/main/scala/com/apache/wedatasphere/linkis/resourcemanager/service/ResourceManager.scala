...
import com.apache.wedatasphere.linkis.resourcemanager.{ResourceInfo, ResultResource}
...
abstract class ResourceManager {
  ...
  /**
    ...
    * @return
    */
  def requestResource(labels: util.List[Label[_]], resource: NodeResource, wait: Long): ResultResource
