...
-- SET @NEBULA_ALL=CONCAT('*-*,',@NEBULA_LABEL); -- MySQL user variable, not supported in PostgreSQL
-- SET @NEBULA_IDE=CONCAT('*-IDE,',@NEBULA_LABEL); -- MySQL user variable, not supported in PostgreSQL
...
-- SET @data_source=CONCAT('/data-source-manager/env-list/all/type/',@data_source_type_id); -- MySQL user variable, not supported in PostgreSQL
...
-- ============================================
-- Linkis Database Upgrade DML Script
-- From: Base Version (db/linkis_dml.sql)
-- To: 1.15.0
...
-- ============================================
-- Version: 1.1.12 (dev-1.1.12)
-- ============================================


-- ============================================
-- Version: 1.3.0 (dev-1.3.0)
-- ============================================
...
-- 注意: 原1.6.0版本的DML中包含CREATE TABLE linkis_org_user_sync语句
-- 该表已在基础DDL中定义,DML文件不应包含DDL语句,因此已移除
-- 参考: db/linkis_ddl.sql 第1260行


-- ============================================
-- Version: 1.7.0 (dev-1.7.0)
-- ============================================
