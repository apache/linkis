...
public enum FtpReaderErrorCode implements ErrorCode {
    ...
    GET_FILE_STATS_ERROR("FtpReader-17", "获取文件状态信息异常"),
    PATH_NOT_FOUND("FtpReader-18", "Path not found"),
    GET_META_SCHEMA_ERROR("FtpReader-19", "Get meta schema information error");
