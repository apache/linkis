...
import com.webank.wedatasphere.linkis.common.utils.ZipUtils;
...
public class DataxEngine {
    ...
    static AbstractContainer container;
    ...
    public static DataxEngine entry(final String[] args) throws Throwable {
    ...
    public static DataxEngine main(String[] args) throws Throwable {

        DataxEngine dataxEngine = null;
        try {
            dataxEngine = DataxEngine.entry(args);
        } catch (Throwable e) {
