...
import com.webank.wedatasphere.linkis.datax.common.spi.EnhancedWriter;
...
public abstract class Writer extends BaseObject {
     ...
     */
    public abstract static class Job extends EnhancedWriter.Job {
     ...
     */
    public abstract static class Task extends EnhancedWriter.Task {
