...
public class PerfTrace {
    ...
    private volatile static PerfTrace instance;
    ...
    private void sumPerf4EndPrint(List<PerfRecord> totalEndReport) {
        ...
        for (PerfRecord perfRecord : totalEndReport) {
            SumPerfRecord4Print oldPrefRecord4Print = perfRecordMaps4print.putIfAbsent(perfRecord.getPhase(), new SumPerfRecord4Print());
            if(oldPrefRecord4Print != null){
                oldPrefRecord4Print.add(perfRecord);
            }else {
