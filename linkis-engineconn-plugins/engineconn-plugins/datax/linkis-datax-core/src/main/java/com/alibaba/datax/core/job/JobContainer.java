...
import com.alibaba.datax.enums.ExecuteMode;
...
import com.webank.wedatasphere.linkis.datax.core.processor.loader.JavaSrcUtils;
...
//                userConf = configuration.clone();
    ...
    @Override
    public void destory() {
        for (Writer.Job jobWriter:jobWriters) {
            if(jobWriter != null) {
                jobWriter.destroy();
            }
        }
