 ...
 */
public class MemoryRecordChannel extends RecordChannel {
    private static final org.slf4j.Logger LOG = LoggerFactory
            .getLogger(MemoryRecordChannel.class);
    ...
    public MemoryRecordChannel(final Configuration configuration) {
        super(configuration);
        super.consumeIsolated = true;
        this.queue = new ArrayBlockingQueue<>(this.getCapacity());
        this.bufferSize = configuration.getInt(CoreConstant.DATAX_CORE_TRANSPORT_RECORD_EXCHANGER_BUFFERSIZE);
