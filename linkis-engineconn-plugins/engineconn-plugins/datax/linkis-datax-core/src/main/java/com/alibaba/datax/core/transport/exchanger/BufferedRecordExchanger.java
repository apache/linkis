...
public class BufferedRecordExchanger implements RecordSender, RecordReceiver {
    ...
    public BufferedRecordExchanger(final RecordChannel recordChannel, final TaskPluginCollector pluginCollector) {
        assert null != recordChannel;
        assert null != recordChannel.getConfiguration();
        ...
        this.bufferSize = configuration
                .getInt(CoreConstant.DATAX_CORE_TRANSPORT_RECORD_EXCHANGER_BUFFERSIZE);
