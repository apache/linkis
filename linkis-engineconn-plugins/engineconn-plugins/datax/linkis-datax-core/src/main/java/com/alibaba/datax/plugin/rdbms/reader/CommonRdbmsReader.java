...
public class CommonRdbmsReader {
    ...
    public static class Job {
        ...
        public void preCheck(Configuration originalConfig, DataBaseType dataBaseType) {
            ...
            String proxyHost = queryConf.getString(Key.PROXY_HOST, DEFAULT_PROXY_SOCKS_HOST);
            int proxyPort = queryConf.getInt(Key.PROXY_PORT, DEFAULT_PROXY_SOCKS_PORT);
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            this.proxyHost = readerSliceConfig.getString(Key.PROXY_HOST, DEFAULT_PROXY_SOCKS_HOST);
            this.proxyPort = readerSliceConfig.getInt(Key.PROXY_PORT, DEFAULT_PROXY_SOCKS_PORT);
        ...
        public void startRead(Configuration readerSliceConfig,
            ...
            try {
                ...
                DBUtil.closeDBResources(stmt, conn);
            }
        }
        ...
        protected Record buildRecord(RecordSender recordSender, ResultSet rs, ResultSetMetaData metaData, int columnNumber, String mandatoryEncoding,
            ...
            try {
                ...
                if (IS_DEBUG) {
                    LOG.debug("read domain " + record.toString()
                            + " occur exception:", e);
                }
                //TODO 这里识别为脏数据靠谱吗？
