...
public final class WriterUtil {
    ...
    public static String getWriteTemplate(List<String> columnHolders, List<String> valueHolders, String writeMode, DataBaseType dataBaseType, boolean forceUseUpdate, List<String> primarykeys) {
        ...
        if (forceUseUpdate ||
            ...
            writeDataSqlTemplate = new StringBuilder().append(onMergeIntoDoString(primarykeys, columnHolders)).toString();
        }
        else {
    ...
    public static String onMergeIntoDoString(List<String> primaryKeys, List<String> columnHolders) {
        StringBuilder sb = new StringBuilder();
        ...
        columnHolders.stream().filter(primaryKeys::contains)
                .forEach(columnHolder -> str.append("TMP.")
                        ...
                        .append(columnHolder)
                        .append("AND"));
        columnHolders.forEach(columnHolder -> {
            sb.append("? AS ").append(columnHolder).append(",");
            insert.append("TMP.").append(columnHolder).append(",");
        });
