...
import com.webank.wedatasphere.linkis.engineconnplugin.datax.executor.DataxOnceCodeExecutor
import com.webank.wedatasphere.linkis.manager.label.entity.Label
import com.webank.wedatasphere.linkis.manager.label.entity.engine.RunType.{APPCONN, RunType}
  ...
  override protected def newExecutor(id: Int, engineCreationContext: EngineCreationContext, engineConn: EngineConn, labels: Array[Label[_]]): OnceExecutor = {
    engineConn.getEngineConnSession match {
      case context: DataxEngineConnContext =>
        new DataxOnceCodeExecutor(id, context)
    }
  }
}
