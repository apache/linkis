...
package com.webank.wedatasphere.linkis.engineplugin.datax

import com.webank.wedatasphere.linkis.engineplugin.datax.builder.DataxProcessEngineConnLaunchBuilder

import java.util
import java.util.List
import com.webank.wedatasphere.linkis.engineplugin.datax.factory.DataxEngineConnFactory
...
class DataxEngineConnPlugin extends EngineConnPlugin{
  ...
  override def getEngineConnLaunchBuilder: EngineConnLaunchBuilder =  EP_CONTEXT_CONSTRUCTOR_LOCK.synchronized {
    if (null == engineLaunchBuilder) {
      engineLaunchBuilder = new DataxProcessEngineConnLaunchBuilder
    }
    engineLaunchBuilder
  }
  ...
  override def getEngineConnFactory: EngineConnFactory = {
    EP_CONTEXT_CONSTRUCTOR_LOCK.synchronized {
      if (null == engineFactory) {
        engineFactory = new DataxEngineConnFactory
      }
      engineFactory
    }
  }
