...
package com.apache.wedatasphere.linkis.engineconnplugin.flink.client.config.entries;


import static com.apache.wedatasphere.linkis.engineconnplugin.flink.client.config.Environment.EXECUTION_ENTRY;
...
public class ExecutionEntry extends ConfigEntry {
	 ...
	 */
	public static ExecutionEntry merge(ExecutionEntry execution1, ExecutionEntry execution2) throws FlinkInitFailedException {
	 ...
	 */
	public static ExecutionEntry enrich(ExecutionEntry execution, Map<String, String> prefixedProperties) throws FlinkInitFailedException {
