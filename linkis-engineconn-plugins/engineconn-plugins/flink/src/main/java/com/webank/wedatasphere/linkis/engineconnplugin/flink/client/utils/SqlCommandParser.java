...
public final class SqlCommandParser {
	 ...
	 */
	public static Optional<SqlCommandCall> parse(String stmt, boolean isBlinkPlanner) throws SqlParseException {
		Optional<SqlCommandCall> call = Arrays.stream(GrammarFactory.getGrammars()).filter(grammar -> grammar.canParse(stmt)).findFirst()
	 ...
	 */
	private static Optional<SqlCommandCall> parseStmt(String stmt, boolean isBlinkPlanner) throws SqlParseException {
