...
public class IMSOptions {
    ...
    public static final CommonVars<String> METRIC_URL_VALUE = CommonVars.apply("wds.linkis.flink.metric.url" , "http://127.0.0.1:10812/ims_data_access/batch_report_metric_by_json.do");
