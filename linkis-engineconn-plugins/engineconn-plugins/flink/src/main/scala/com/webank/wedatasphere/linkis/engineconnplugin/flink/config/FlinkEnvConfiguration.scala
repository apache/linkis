...
object FlinkEnvConfiguration {
  ...
  val FLINK_DIST_JAR_PATH = CommonVars("flink.dist.jar.path", "/appcom/Install/flink/lib/flink-dist_2.11-1.11.1.jar")
  ...
  val FLINK_ENV_TYPE = CommonVars("flink.app.env.type", EnvLabel.DEV)
  ...
  val FLINK_APPLICATION_STATUS_FETCH_INTERVAL = CommonVars("flink.app.fetch.status.interval", new TimeType("5s"))
