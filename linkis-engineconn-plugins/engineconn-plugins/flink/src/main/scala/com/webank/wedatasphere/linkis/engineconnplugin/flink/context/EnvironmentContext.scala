...
import org.apache.flink.client.deployment.{ClusterClientServiceLoader, DefaultClusterClientServiceLoader}
...
class EnvironmentContext(defaultEnv: Environment,
  ...
  private var clusterClientServiceLoader: ClusterClientServiceLoader = _
  ...
  def getClusterClientServiceLoader: ClusterClientServiceLoader = clusterClientServiceLoader
  ...
  override def hashCode: Int = Objects.hash(defaultEnv, dependencies, flinkConfig, clusterClientServiceLoader)
}
