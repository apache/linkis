...
package com.apache.wedatasphere.linkis.engineplugin.hive.conf
...
object HiveEngineConfiguration {
  ...
  val BASE64_SERDE_CLASS =  CommonVars[String]("wds.linkis.hive.base64.serde.class","com.apache.wedatasphere.linkis.engineplugin.hive.serde.CustomerDelimitedJSONSerDe").getValue
}
