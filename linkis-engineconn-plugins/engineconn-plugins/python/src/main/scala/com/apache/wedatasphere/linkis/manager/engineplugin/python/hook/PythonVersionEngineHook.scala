...
package com.apache.wedatasphere.linkis.manager.engineplugin.python.hook
...
import com.apache.wedatasphere.linkis.manager.engineplugin.python.executor.PythonSession
...
class PythonVersionEngineHook  extends EngineConnHook with Logging{
  ...
  override def afterExecutionExecute(engineCreationContext:  _root_.com.apache.wedatasphere.linkis.engineconn.common.creation.EngineCreationContext, engineConn:  _root_.com.apache.wedatasphere.linkis.engineconn.common.engineconn.EngineConn): Unit = {
