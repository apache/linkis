...
package com.apache.wedatasphere.linkis.manager.engineplugin.python.utils
...
object Kind {
  ...
  def getKind(code: String): String = {
    ...
    if (kindStr.matches("[%|@][a-zA-Z]{1,12}")) kindStr.substring(1) else throw new IllegalArgumentException("Unknown kind " + kindStr)
  }
