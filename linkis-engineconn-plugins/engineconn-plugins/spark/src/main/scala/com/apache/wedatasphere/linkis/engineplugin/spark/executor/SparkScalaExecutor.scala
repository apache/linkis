...
package com.apache.wedatasphere.linkis.engineplugin.spark.executor
...
import com.apache.wedatasphere.linkis.engineconn.computation.executor.execute.EngineExecutionContext
import com.apache.wedatasphere.linkis.engineconn.computation.executor.rs.RsOutputStream
import com.apache.wedatasphere.linkis.engineconn.core.executor.ExecutorManager
import com.apache.wedatasphere.linkis.engineplugin.spark.common.{Kind, SparkScala}
import com.apache.wedatasphere.linkis.engineplugin.spark.config.SparkConfiguration
import com.apache.wedatasphere.linkis.engineplugin.spark.entity.SparkEngineSession
import com.apache.wedatasphere.linkis.engineplugin.spark.exception.{ApplicationAlreadyStoppedException, ExecuteError, SparkSessionNullException}
import com.apache.wedatasphere.linkis.engineplugin.spark.utils.EngineUtils
import com.apache.wedatasphere.linkis.governance.common.paser.ScalaCodeParser
import com.apache.wedatasphere.linkis.scheduler.executer.{ErrorExecuteResponse, ExecuteResponse, IncompleteExecuteResponse, SuccessExecuteResponse}
import com.apache.wedatasphere.linkis.storage.resultset.ResultSetWriter
...
class SparkScalaExecutor(sparkEngineSession: SparkEngineSession, id: Long) extends SparkEngineConnExecutor(sparkEngineSession.sparkContext, id) {
  ...
  def bindSparkSession = {
    ...
    sparkILoop.beSilentDuring {
      ...
      sparkILoop.bind("engineExecutionContextFactory", "com.apache.wedatasphere.linkis.engineplugin.spark.executor.EngineExecutionContextFactory", engineExecutionContextFactory)
      ...
      sparkILoop.interpret("import com.apache.wedatasphere.linkis.engineplugin.spark.executor.SQLSession.showDF")
      sparkILoop.interpret("import com.apache.wedatasphere.linkis.engineplugin.spark.executor.SQLSession.showHTML")
      ...
      sparkILoop.interpret("import com.apache.wedatasphere.linkis.engineplugin.spark.executor.EngineExecutionContextFactory")
