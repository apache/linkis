...
package com.apache.wedatasphere.linkis.engineplugin.spark.launch

import java.lang.ProcessBuilder.Redirect
import java.util
import com.google.common.collect.Lists
import com.apache.wedatasphere.linkis.common.conf.CommonVars
import com.apache.wedatasphere.linkis.engineplugin.spark.config.SparkResourceConfiguration.LINKIS_SPARK_DRIVER_MEMORY
import com.apache.wedatasphere.linkis.engineplugin.spark.config.{SparkConfiguration, SparkResourceConfiguration}
import com.apache.wedatasphere.linkis.engineplugin.spark.launch.SparkSubmitProcessEngineConnLaunchBuilder.{AbsolutePath, Path, RelativePath, getValueAndRemove}
import com.apache.wedatasphere.linkis.manager.common.entity.resource.{DriverAndYarnResource, NodeResource}
import com.apache.wedatasphere.linkis.manager.engineplugin.common.conf.EnvConfiguration
import com.apache.wedatasphere.linkis.manager.engineplugin.common.launch.entity.EngineConnBuildRequest
import com.apache.wedatasphere.linkis.manager.engineplugin.common.launch.process.Environment._
import com.apache.wedatasphere.linkis.manager.engineplugin.common.launch.process.JavaProcessEngineConnLaunchBuilder
...
import com.apache.wedatasphere.linkis.protocol.UserWithCreator
...
//    info("No need to add jars for " + _jars.map(fromPath).exists(x => x.equals("hdfs:///")).toString())
  ...
  def build(engineRequest: EngineConnBuildRequest): Unit = {
    ...
    //this.conf("spark.sql.extensions", "com.apache.wedatasphere.linkis.hook.spark.extension.SparkHistoryExtension")
