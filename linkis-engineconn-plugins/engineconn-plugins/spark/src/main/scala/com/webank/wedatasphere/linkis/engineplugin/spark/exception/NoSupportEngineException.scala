...
/**
  *
  */
case class NoSupportEngineException(errCode: Int, desc: String) extends ErrorException(errCode, desc)

case class NotSupportSparkTypeException(errorCode: Int, desc: String) extends ErrorException(errorCode, desc)
