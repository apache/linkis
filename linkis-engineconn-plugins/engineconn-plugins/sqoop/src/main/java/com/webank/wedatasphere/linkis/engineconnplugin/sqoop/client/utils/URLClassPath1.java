...
public class URLClassPath1 {
     ...
     */
    public URLClassPath1(URL[] urls, URLStreamHandlerFactory factory) {
    ...
    public Resource getResource(String name, boolean check) {
        ...
        for (int i = 0; (loader = getLoader(i)) != null; i++) {
            ...
            String pattern = String.format(".*%s-.*jar!.*/%s.class","linkis-engineplugin-sqoop","JobBase");
            if(res!=null && name.equals("org/apache/sqoop/mapreduce/JobBase.class") && !Pattern.matches(pattern, res.getURL().getFile())) {
              continue;
            }
            if (res != null) {
                return res;
