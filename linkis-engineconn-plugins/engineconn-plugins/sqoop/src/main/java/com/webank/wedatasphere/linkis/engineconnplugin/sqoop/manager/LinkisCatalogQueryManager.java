...
public abstract class LinkisCatalogQueryManager extends LinkisGenericJdbcManager{
    public static final Log LOG = LogFactory.getLog(
            LinkisCatalogQueryManager.class.getName());

    public LinkisCatalogQueryManager(final String driverClass,
