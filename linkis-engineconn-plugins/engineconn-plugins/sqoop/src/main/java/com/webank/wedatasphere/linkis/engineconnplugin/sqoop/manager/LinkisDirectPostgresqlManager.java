 ...
 * commands.
 */
public class LinkisDirectPostgresqlManager
        extends LinkisPostgresqlManager {

    public static final Log LOG = LogFactory.getLog(
            LinkisDirectPostgresqlManager.class.getName());
    ...
    public LinkisDirectPostgresqlManager(final SqoopOptions opts) {
        super(opts);
    ...
    static class PostgresqlAsyncSink extends ErrorableAsyncSink {
        ...
        public void processStream(InputStream is) {
            child = new LinkisDirectPostgresqlManager.PostgresqlAsyncSink.PostgresqlStreamThread(is, writer, options, counters);
            child.start();
        }

        private static class PostgresqlStreamThread extends ErrorableThread {
            public static final Log LOG = LogFactory.getLog(
                    LinkisDirectPostgresqlManager.PostgresqlAsyncSink.PostgresqlStreamThread.class.getName());
    ...
    public void importTable(com.cloudera.sqoop.manager.ImportJobContext context)
        ...
        try {
            ...
            sink = new LinkisDirectPostgresqlManager.PostgresqlAsyncSink(w, options, counters);
    ...
    public void exportTable(ExportJobContext context)
        ...
        context.setConnManager(this);
        LinkisExportJobBase job =
                new LinkisExportJobBase(context,
                        null,
