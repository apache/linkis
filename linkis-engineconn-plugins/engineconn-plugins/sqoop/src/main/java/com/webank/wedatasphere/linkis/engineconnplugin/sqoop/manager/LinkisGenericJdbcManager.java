...
public class LinkisGenericJdbcManager extends LinkisSqlManager{


    public static final Log LOG = LogFactory.getLog(
            org.apache.sqoop.manager.GenericJdbcManager.class.getName());

    private String jdbcDriverClass;
    private Connection connection;
    private static final String SCHEMA = "schema";

    public LinkisGenericJdbcManager(final String driverClass, final SqoopOptions opts) {
        super(opts);
