...
public class LinkisJdbcUpdateExportJob extends LinkisExportJobBase{
    // Fix For Issue [SQOOP-2846]
    private FileType fileType;
    public static final Log LOG = LogFactory.getLog(
            LinkisJdbcUpdateExportJob.class.getName());
    ...
    public LinkisJdbcUpdateExportJob(final ExportJobContext context)
            throws IOException {
        super(context, null, null, getUpdateOutputFormat());
    }

    public LinkisJdbcUpdateExportJob(final ExportJobContext ctxt,
