...
public class LinkisMySQLExportJob extends LinkisExportJobBase{
    public static final Log LOG =
            LogFactory.getLog(LinkisMySQLExportJob.class.getName());

    public LinkisMySQLExportJob(final ExportJobContext context) {
