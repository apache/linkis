...
public class LinkisPostgresqlManager extends LinkisCatalogQueryManager{
    public static final String SCHEMA = "schema";

    public static final Log LOG = LogFactory.getLog(
            org.apache.sqoop.manager.PostgresqlManager.class.getName());
    ...
    public LinkisPostgresqlManager(final SqoopOptions opts) {
