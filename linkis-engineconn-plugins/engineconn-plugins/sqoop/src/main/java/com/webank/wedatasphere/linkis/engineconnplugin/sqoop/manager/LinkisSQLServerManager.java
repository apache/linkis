...
public class LinkisSQLServerManager extends LinkisInformationSchemaManager{
    ...
    public static final Log LOG = LogFactory.getLog(
            LinkisSQLServerManager.class.getName());
    ...
    public LinkisSQLServerManager(final SqoopOptions opts) {
        this(DRIVER_CLASS, opts);
    }

    public LinkisSQLServerManager(final String driver, final SqoopOptions opts) {
        super(driver, opts);
    ...
    public void exportTable(com.cloudera.sqoop.manager.ExportJobContext context)
        ...
        LinkisJdbcExportJob exportJob;
        if (isNonResilientOperation()) {
            exportJob = new LinkisJdbcExportJob(context, null, null,
    ...
    public void updateTable(
        ...
        if (isNonResilientOperation()) {
            ...
            context.setConnManager(this);
            LinkisExportJobBase exportJob = new LinkisExportJobBase(context, null,
    ...
    public void upsertTable(com.cloudera.sqoop.manager.ExportJobContext context)
        ...
        LinkisExportJobBase exportJob =
                new LinkisExportJobBase(context,null,null, SqlServerUpsertOutputFormat.class);
        exportJob.runExport();
    }
