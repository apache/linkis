...
package com.webank.wedatasphere.linkis.engineplugin.sqoop

import com.webank.wedatasphere.linkis.engineplugin.sqoop.builder.SqoopProcessEngineConnLaunchBuilder

import java.util
import java.util.List
import com.webank.wedatasphere.linkis.engineplugin.sqoop.factory.SqoopEngineConnFactory
...
class SqoopEngineConnPlugin extends EngineConnPlugin{
  ...
  override def getEngineConnLaunchBuilder: EngineConnLaunchBuilder =  EP_CONTEXT_CONSTRUCTOR_LOCK.synchronized {
    if (null == engineLaunchBuilder) {
      engineLaunchBuilder = new SqoopProcessEngineConnLaunchBuilder
    }
    engineLaunchBuilder
  }
  ...
  override def getEngineConnFactory: EngineConnFactory = {
    EP_CONTEXT_CONSTRUCTOR_LOCK.synchronized {
      if (null == engineFactory) {
        engineFactory = new SqoopEngineConnFactory
      }
      engineFactory
    }
  }
