...
package com.webank.wedatasphere.linkis.engineplugin.sqoop.factory
...
import com.webank.wedatasphere.linkis.engineplugin.sqoop.executor.SqoopEngineConnExecutor
...
class SqoopEngineConnFactory extends ComputationSingleExecutorEngineConnFactory{
  override protected def getRunType: RunType = RunType.SQOOP
  ...
  override protected def newExecutor(id: Int, engineCreationContext: EngineCreationContext, engineConn: EngineConn): LabelExecutor =
    new SqoopEngineConnExecutor(id)
