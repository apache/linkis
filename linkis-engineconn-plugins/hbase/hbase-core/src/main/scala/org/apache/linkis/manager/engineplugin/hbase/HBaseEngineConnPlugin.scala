...
import org.apache.linkis.manager.engineplugin.hbase.builder.HBaseProcessEngineConnLaunchBuilder
import org.apache.linkis.manager.engineplugin.hbase.factory.HBaseEngineConnFactory
import org.apache.linkis.manager.label.entity.Label

import java.util

class HBaseEngineConnPlugin extends EngineConnPlugin {
  ...
  override def getEngineConnLaunchBuilder: EngineConnLaunchBuilder = {
    new HBaseProcessEngineConnLaunchBuilder
  }

  override def getEngineConnFactory: EngineConnFactory = {
    if (null == engineFactory) engineFactoryLocker synchronized {
      engineFactory = new HBaseEngineConnFactory
    }
    engineFactory
  }
