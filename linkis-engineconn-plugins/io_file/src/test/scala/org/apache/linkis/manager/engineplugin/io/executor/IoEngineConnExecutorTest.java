...
class IoEngineConnExecutorTest {
    ...
    public void testExecuteLine() {
        ...
        EngineExecutionContext engineExecutionContext = new EngineExecutionContext(ioEngineConnExecutor, "hadoop");
        engineExecutionContext.setJobId("jobId-1");
        Object[] objects = new Object[10];
        MethodEntity methodEntity = new MethodEntity(0L, "file", "hadoop", "hadoop",
                "localhost", "init", objects);
        AliasOutputExecuteResponse executeResponse = (AliasOutputExecuteResponse)ioEngineConnExecutor.executeLine(engineExecutionContext, MethodEntitySerializer.serializer(methodEntity));
        ...
        methodEntity = new MethodEntity(0L, "file", "hadoop", "hadoop",
                "localhost", "write", objects);
        ExecuteResponse writeResponse = ioEngineConnExecutor.executeLine(engineExecutionContext, MethodEntitySerializer.serializer(methodEntity));
        ...
        objects[0] = fsPathStr;
        methodEntity = new MethodEntity(0L, "file", "hadoop", "hadoop",
                "localhost", "read", objects);
        AliasOutputExecuteResponse readResponse = (AliasOutputExecuteResponse)ioEngineConnExecutor.executeLine(engineExecutionContext, MethodEntitySerializer.serializer(methodEntity));
        Assertions.assertThat(readResponse).isNotNull();
        Assertions.assertThat(readResponse.output()).isEqualTo("dolphin000000000300000000040,110000000016aGVsbG8gd29ybGQ=");
    }
