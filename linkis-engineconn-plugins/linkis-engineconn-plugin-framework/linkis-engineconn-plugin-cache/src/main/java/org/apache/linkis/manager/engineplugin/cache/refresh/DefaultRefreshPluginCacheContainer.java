...
public class DefaultRefreshPluginCacheContainer implements RefreshPluginCacheContainer {
    ...
    public void addRefreshListener(
            RefreshableEngineConnPluginCache.RefreshListener refreshListener) {
    ...
    private void startExecutors() {
        ...
        this.scheduleService =
                Executors.newSingleThreadExecutor(
                        new RefreshThreadFactory(REFRESH_SCHEDULE_THREAD));
        // OOM ?
        this.workService =
                                                        ...
                                                        () ->
                                                                operation
                                                                        ...
                                                                        .apply(
                                                                                operation
                                                                                        .pluginInfo()));
                                        EngineConnPluginInstance newPluginInstance =
                                                future.get(12, TimeUnit.HOURS);
                                        if (null != newPluginInstance) {
                                            // Refresh the cache;
                                            this.pluginCache.refresh(
                                                    newPluginInstance.info(), newPluginInstance);
