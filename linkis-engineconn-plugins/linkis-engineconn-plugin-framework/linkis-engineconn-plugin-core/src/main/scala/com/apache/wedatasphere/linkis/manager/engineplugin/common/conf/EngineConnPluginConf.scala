...
package com.apache.wedatasphere.linkis.manager.engineplugin.common.conf
...
object EngineConnPluginConf {
  ...
  val ENGINECONN_MAIN_CLASS = CommonVars[String]("wds.linkis.engineconn.main.class", "com.apache.wedatasphere.linkis.engineconn.launch.EngineConnServer")
