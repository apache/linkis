...
package scala.org.apache.linkis.manager.engineplugin.pipeline.factory
...
class TestPipelineEngineConnFactory {

  @Test
  def testNewExecutor: Unit = {
    System.setProperty("pipelineVersion", "pipeline")
    val engineConnFactory: PipelineEngineConnFactory = new PipelineEngineConnFactory
    val engineCreationContext: EngineCreationContext = new DefaultEngineCreationContext
    val jMap = new java.util.HashMap[String, String]()
    jMap.put("pipeline.version", "pipeline")
