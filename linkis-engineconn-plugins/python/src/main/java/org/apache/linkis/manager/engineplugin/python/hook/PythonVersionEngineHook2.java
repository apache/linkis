...
public class PythonVersionEngineHook2 implements EngineConnHook {

    private static final Logger logger = LoggerFactory.getLogger(PythonVersionEngineHook2.class);
    ...
    public void beforeCreateEngineConn(EngineCreationContext engineCreationContext) {
        ...
        pythonExtraPackage = params.getOrDefault("python.application.pyFiles", "file:///mnt/bdap/test/test/test.zip");
