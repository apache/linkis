...
public class JavaReplAdapter extends ReplAdapter {
  @Override
  public void executorCode(String code, String classpathDir, String methodName) throws Exception {
    JavaReplCompiler compiler = new JavaReplCompiler();

    compiler.compileAndExecutor(
        code, Thread.currentThread().getContextClassLoader(), classpathDir, methodName);
  }
}
