...
public class ShellEngineConnPlugin2 implements EngineConnPlugin {
    ...
    public void init(Map<String, Object> params) {
        Label<?> engineTypeLabel = EngineTypeLabelCreator.createEngineTypeLabel(EngineType.SHELL().toString());
