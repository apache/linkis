...
public class ReaderThread2 extends Thread {
    private static final Logger logger = LoggerFactory.getLogger(ReaderThread2.class);
    ...
    private final int logListCount = CommonVars.<Integer>apply("wds.linkis.engineconn.log.list.count", 50).getValue();
    private CountDownLatch counter;

    private boolean isReaderAlive = true;

    public  ReaderThread2(EngineExecutionContext engineExecutionContext,
