...
public class TrinoConfiguration2 {
    ...
    public static final CommonVars<String> TRINO_SCHEMA =
            CommonVars.apply("linkis.trino.schema", "");
    ...
    public static final CommonVars<String> TRINO_DEFAULT_USER =
            CommonVars.apply("linkis.trino.default.start.user",
