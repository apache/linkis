...
public class MonitorConfig {
  ...
  public static final CommonVars<String> CHATBOT_URL= CommonVars.apply("linkis.monitor.chatbot.url","http://127.0.0.1:1377/pros-chatbot/yuanfang/sendEMsg");
  public static final CommonVars<String> SOLUTION_URL = CommonVars.apply("linkis.monitor.jobhistory.solution.url", "http://kn.dss.localhost/linkis/qa");
}
