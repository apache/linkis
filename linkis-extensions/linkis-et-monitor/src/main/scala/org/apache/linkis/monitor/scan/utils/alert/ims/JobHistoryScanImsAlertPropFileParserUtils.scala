...
object JobHistoryScanImsAlertPropFileParserUtils extends Logging {
  ...
  def getAlerts(prefix: String): util.Map[String, AlertDesc] = {
    ...
    Utils.tryFinally {
        Utils.tryCatch {
            ...
            throw new AnomalyScannerException(21304, "Failed to load alerts from alert properties. Cause: " + ExceptionUtils.getMessage(t))
            return ret
            }
        }
    } {
