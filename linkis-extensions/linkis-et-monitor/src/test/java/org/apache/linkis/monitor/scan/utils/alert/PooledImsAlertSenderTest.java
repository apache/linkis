...
import org.apache.linkis.monitor.scan.utils.alert.ims.ImsAlertLevel;
import org.apache.linkis.monitor.scan.utils.alert.ims.ImsAlertWay;
import org.apache.linkis.monitor.scan.utils.alert.ims.PooledImsAlertSender;
...
public class PooledImsAlertSenderTest {
  ...
  public void doSendAlert() throws Exception {
    ...
    String url = "http://127.0.0.1:10812/ims_data_access/send_alarm_by_json.do";
