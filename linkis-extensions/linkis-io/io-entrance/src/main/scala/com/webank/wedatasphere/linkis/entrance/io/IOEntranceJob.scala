...
/**
  ...
  */
class IOEntranceJob extends ClientJob with Logging{

  override def isJobShouldRetry(errorExecuteResponse: ErrorExecuteResponse): Boolean = isJobSupportRetry

  override def isJobSupportRetry: Boolean = {
    false
  }
}
