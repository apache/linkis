...
package com.apache.wedatasphere.linkis.orchestrator.conf
...
object OrchestratorConfiguration {
  ...
  val ORCHESTRATOR_EXECUTION_FACTORY = CommonVars("wds.linkis.orchestrator.execution.factory.class", "com.apache.wedatasphere.linkis.orchestrator.code.plans.execution.CodeExecutionFactory")
