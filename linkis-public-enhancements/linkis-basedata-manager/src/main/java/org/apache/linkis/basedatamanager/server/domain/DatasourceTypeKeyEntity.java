...
public class DatasourceTypeKeyEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getDataSourceTypeId() == null ? other.getDataSourceTypeId() == null : this.getDataSourceTypeId().equals(other.getDataSourceTypeId()))
            ...
            && (this.getValueRegex() == null ? other.getValueRegex() == null : this.getValueRegex().equals(other.getValueRegex()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDataSourceTypeId() == null) ? 0 : getDataSourceTypeId().hashCode());
