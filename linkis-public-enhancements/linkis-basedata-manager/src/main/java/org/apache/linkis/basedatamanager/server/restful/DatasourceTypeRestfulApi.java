...
public class DatasourceTypeRestfulApi {
  ...
  @Autowired DatasourceTypeService datasourceTypeService;
  ...
  @ApiOperation(value = "list", notes = "list Datasource Types", httpMethod = "GET")
  @RequestMapping(path = "", method = RequestMethod.GET)
  public Message list(
      HttpServletRequest request, String searchName, Integer currentPage, Integer pageSize) {
    ModuleUserUtils.getOperationUser(
        request, "Query list data of Datasource Type,search name:" + searchName);
  ...
  @ApiOperation(value = "get", notes = "Get a Datasource Type by id", httpMethod = "GET")
  ...
  @ApiOperation(
      value = "remove",
      notes = "Remove a Datasource Type Record by id",
      httpMethod = "DELETE")
  ...
  public Message update(
      HttpServletRequest request, @RequestBody DatasourceTypeEntity datasourceType) {
    String username =
        ModuleUserUtils.getOperationUser(
            request, "Update a Datasource Type Record,id:" + datasourceType.getId().toString());
    if (!Configuration.isAdmin(username)) {
      return Message.error("User '" + username + "' is not admin user[非管理员用户]");
    }
