...
class RmExternalResourceProviderMapperTest extends BaseDaoTest {
  ...
  @Autowired RmExternalResourceProviderMapper rmExternalResourceProviderMapper;
  ...
  void getListByPage() {
    insert();
    List<RmExternalResourceProviderEntity> list =
        rmExternalResourceProviderMapper.getListByPage("a");
