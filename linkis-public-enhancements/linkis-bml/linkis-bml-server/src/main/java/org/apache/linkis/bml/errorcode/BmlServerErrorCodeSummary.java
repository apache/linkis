...
public enum BmlServerErrorCodeSummary {
  ...
  FAILED_UPDATE_RESOURCES(
      60051, "Failed to update resources(更新资源失败)", ""),
  BML_QUERY_FAILEXCEPTION(70068, "", ""),
  FAILED_DOWNLOAD_RESOURCE(
      70068, "Failed to download the resource(下载资源失败)", ""),
  ...
  BULK_DELETE_FAILED(
      70068,
      "The batch delete resource operation failed(批量删除资源操作失败)",
      ""),
  RESOURCEID_BEEN_DELETED(
      70068,
      "ResourceID:{0} is empty, illegal or has been deleted (resourceId{0}:为空,非法或者已被删除!)",
      ""),
  VERSION_BEEN_DELETED(
      70068,
      "version:{0} is empty, illegal or has been deleted (version:{0} 为空,非法或者已被删除!)",
      ""),
  ...
  PARAMETERS_IS_NULL(
      78361,
      "Batch deletion of resourceIDS parameters is null(批量删除资源操作传入的resourceIds参数为空)",
      ""),
  BULK_DELETION_PARAMETERS(
      78361,
      "Batch deletion of unpassed resourceIDS parameters(批量删除未传入resourceIds参数)",
      ""),
