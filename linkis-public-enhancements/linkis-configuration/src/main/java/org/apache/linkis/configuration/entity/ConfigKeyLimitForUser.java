...
public class ConfigKeyLimitForUser {
    ...
    /**
     * 组合标签 combined_userCreator_engineType  如 hadoop-IDE,spark-2.4.3
     * 表字段 : combined_label_value
     * 字段类型 : varchar(200)
     */
    private String combinedLabelValue;

    /**
     * id of linkis_ps_configuration_config_key
     * 表字段 : key_id
     * 字段类型 : bigint(19)
     */
    private Long keyId;
    ...
    /**
     * uuid  第三方侧记录的模板id
     * 表字段 : latest_update_template_uuid
     * 字段类型 : varchar(34)
     */
