...
public class ConfigurationRestfulApi {
    ...
    public Message getFullTreesByAppName(
        ...
        if (creator != null && (creator.equals("通用设置") || creator.equals("全局设置")||creator.equals("GlobalSettings"))) {
            engineType = "*";
            version = "*";
            creator = "*";
        }
        ...
        ArrayList<ConfigTree> configTrees =
                configurationService.getFullTreeByLabelList(labelList, true,req.getHeader("Content-Language"));
    ...
    public Message getCategory(HttpServletRequest req) {
        List<CategoryLabelVo> categoryLabelList = categoryService.getAllCategory(req.getHeader("Content-Language"));
