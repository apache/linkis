...
public class TenantConfigServiceImpl implements TenantConfigService {
    ...
    private void dataProcessing(TenantVo tenantVo) throws ConfigurationException {
        ...
        //对比ecm tenant的值
        if (!tenantResult.get()) throw new ConfigurationException("The ECM with the corresponding label was not found");
        ...
        if (!creator.equals(tenantValue)) throw new ConfigurationException("tenantValue should contain creator first");
    }
