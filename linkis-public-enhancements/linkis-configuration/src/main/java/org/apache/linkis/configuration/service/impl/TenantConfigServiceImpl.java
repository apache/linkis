...
public class TenantConfigServiceImpl implements TenantConfigService {
    ...
    public List<TenantVo> queryTenantList(String user, String creator, String tenant) {
        ...
        return userTenantMapper.queryTenantList(user, creator, tenant);
    }
    ...
    @Override
    public Boolean checkUserCteator(String user, String creator, String tenant) {
        return CollectionUtils.isNotEmpty(queryTenantList(user, creator, tenant));
    }
}
