...
(
    ...
    `id`               int(2) NOT NULL  COMMENT '0  none/ 1 with mix /2 with max / 3 min and max both',
    PRIMARY KEY (`id`)
);
...
CREATE TABLE `linkis_ps_configuration_template_config_key` (
        ...
        `template_uuid` varchar(34) NOT NULL COMMENT 'uuid  第三方侧记录的模板id',
        ...
        `is_valid` varchar(2) NULL DEFAULT NULL COMMENT '是否有效 预留 Y/N',
...
CREATE TABLE `linkis_ps_configuration_key_limit_for_user` (
        ...
        `key_id` int(20) NOT NULL COMMENT 'id of linkis_ps_configuration_config_key',
        `latest_update_template_uuid` varchar(34) NOT NULL COMMENT 'uuid  第三方侧记录的模板id',
        `is_valid` varchar(2) NULL DEFAULT NULL COMMENT '是否有效 预留 Y/N',
        `create_by` varchar(50) NOT NULL COMMENT '创建人',
        `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'create time',
        `update_by` varchar(50) NULL DEFAULT NULL COMMENT '更新人',
