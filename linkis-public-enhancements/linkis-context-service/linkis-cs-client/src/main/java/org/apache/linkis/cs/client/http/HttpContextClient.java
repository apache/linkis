...
public class HttpContextClient extends AbstractContextClient {
    ...
    public Context createContext(
        ...
        if (result instanceof ContextCreateResult) {
            ...
            LOGGER.error(
                    "result is not a correct type, result type is {}",
    ...
    public ContextValue getContextValue(ContextID contextID, ContextKey contextKey)
        ...
        try {
            ...
            LOGGER.error(
                    "get context value id: {} , key: {} failed", contextIDStr, contextKeyStr, e);
    ...
    public void reset(ContextID contextID, ContextKey contextKey) throws ErrorException {
        ...
        try {
            ...
            LOGGER.error(
                    "reset contextID {}, contextKey {}  failed", contextIdStr, contextKeyStr, e);
    ...
    public void remove(ContextID contextID, ContextKey contextKey) throws ErrorException {
        String contextIdStr = SerializeHelper.serializeContextID(contextID);
        String contextKeyStr = SerializeHelper.serializeContextKey(contextKey);
        ContextRemoveAction contextRemoveAction =
                new ContextRemoveAction(contextIdStr, contextKeyStr);
        ...
        try {
            ...
            LOGGER.error(
                    "remove context id {} context key {} failed", contextIdStr, contextIdStr, e);
    ...
    @Override
    public void bindContextKeyListener(ContextKeyListener contextKeyListener)
            throws ErrorException {
        ...
        try {
            ...
            LOGGER.error(
                    "bind context id {} context key {} failed", contextIDStr, contextKeyStr, e);
                            ...
                            .map(
                                    s -> {
                                        try {
                                            ...
                                            LOGGER.error(
                                                    "failed to deserialize {} to a contextKeyValue",
                                                    s,
                                                    e);
                                            return null;
                                        }
