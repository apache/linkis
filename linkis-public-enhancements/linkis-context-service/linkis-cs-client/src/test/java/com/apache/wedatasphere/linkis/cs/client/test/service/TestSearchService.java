...
//            contextKey.setKeywords("xddd");
            ...
            BMLResource resource = searchService.getContextValue(contextID, contextKey, LinkisBMLResource.class);
        ...
        BMLResource bmlResource = searchService.searchContext(contextID, "cooper", "sql", LinkisBMLResource.class);
        contextClient.close();
