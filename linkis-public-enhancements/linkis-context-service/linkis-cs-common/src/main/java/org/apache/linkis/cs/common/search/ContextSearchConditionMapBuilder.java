    ...
    public Map<Object, Object> build() {
        ...
        if (contextValueTypeMap != null) {
            conditionMap =
                    conditionMap == null
                            ? contextValueTypeMap
                            : and(conditionMap, contextValueTypeMap);
        }
        if (contextScopeMap != null) {
            conditionMap =
                    conditionMap == null ? contextScopeMap : and(conditionMap, contextScopeMap);
        }
        if (regexMap != null) {
        ...
        if (containsValueMap != null) {
            conditionMap =
                    conditionMap == null ? containsValueMap : and(conditionMap, containsValueMap);
        }
        if (nearest) {
    ...
    public ContextSearchConditionMapBuilder contextValueTypes(Class... contextValueTypes) {
        for (Class contextValueType : contextValueTypes) {
            if (contextValueTypeMap == null) {
                ...
                contextValueTypeMap =
                        or(contextValueTypeMap, getByContextValueType(contextValueType));
            }
        }
        return this;
    }
