...
package com.apache.wedatasphere.linkis.cs.persistence.aop;

import com.apache.wedatasphere.linkis.DataWorkCloudApplication;
import com.apache.wedatasphere.linkis.cs.persistence.conf.PersistenceConf;
...
public class PersistenceTuningAspect {
    ...
    @Pointcut(value = "@annotation(com.apache.wedatasphere.linkis.cs.persistence.annotation.Tuning)")
    private void cut() {
    }
