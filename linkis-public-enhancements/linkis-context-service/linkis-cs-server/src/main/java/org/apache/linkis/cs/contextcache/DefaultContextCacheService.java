...
public class DefaultContextCacheService implements ContextCacheService {
    ...
    public ContextKeyValue get(ContextID contextID, ContextKey csKey) {
        ...
        try {
            ...
            logger.error(
                    String.format(
                            "Failed to get contextID(%s) of csKey(%s)",
                            contextID.getContextId(), csKey.getKey()),
                    e);
        }
        return null;
    ...
    @Override
    public List<ContextKeyValue> getValues(
            ContextID contextID, String keyword, ContextType csType) {
    ...
    @Override
    public List<ContextKeyValue> getAllLikes(
            ContextID contextID, String regex, ContextType csType) {
        ...
        try {
            ...
            logger.error(
                    String.format(
                            "Failed to getAllLikes contextID(%s) of regex(%s)",
                            contextID.getContextId(), regex),
                    e);
        }
        return null;
    }
    ...
    public List<ContextKeyValue> getAll(ContextID contextID) {
        ...
        try {
            ...
            logger.error(
                    String.format("Failed to getAllByType contextID(%s)", contextID.getContextId()),
                    e);
        }
        return null;
    }
    ...
    public void removeAll(ContextID contextID) {
        ...
        try {
            ...
            logger.error(
                    String.format("Failed to removeAll contextID(%s)", contextID.getContextId()),
                    e);
        }
    }
    ...
    public void removeAll(ContextID contextID, ContextType csType) {
        ...
        try {
            ...
            logger.error(
                    String.format(
                            "Failed to removeAll contextID(%s) of csType(%s)",
                            contextID.getContextId(), csType),
                    e);
        }
    }
