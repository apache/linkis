...
public class SqlConnection implements Closeable {
    ...
    private static final CommonVars<String> SQL_DRIVER_CLASS =
            CommonVars.apply("wds.linkis.server.mdm.service.greenplum.driver", "com.pivotal.jdbc.GreenplumDriver");

    private static final CommonVars<String> SQL_CONNECT_URL =
            CommonVars.apply("wds.linkis.server.mdm.service.greenplum.url", "jdbc:pivotal:greenplum://%s:%s;DatabaseName=%s");
