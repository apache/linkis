...
package com.apache.wedatasphere.linkis.metadata.conf
...
object MdqConfiguration {
  ...
  val SPARK_MDQ_IMPORT_CLAZZ = CommonVars("wds.linkis.spark.mdq.import.clazz", "com.apache.wedatasphere.linkis.engineplugin.spark.imexport.LoadData")
