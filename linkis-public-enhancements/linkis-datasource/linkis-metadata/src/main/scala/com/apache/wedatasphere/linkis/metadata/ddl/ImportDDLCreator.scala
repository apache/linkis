...
package com.apache.wedatasphere.linkis.metadata.ddl
...
import com.apache.wedatasphere.linkis.metadata.conf.MdqConfiguration
import com.apache.wedatasphere.linkis.metadata.domain.mdq.bo.{MdqTableBO, MdqTableFieldsInfoBO}
import com.apache.wedatasphere.linkis.metadata.exception.MdqIllegalParamException
...
//      createTableCode.append("com.apache.wedatasphere.linkis.engine.imexport.LoadData.loadDataToTable(spark,source,destination)")
    ...
    resultCode
    //    if(storePath == null){
    //      newExecutionCode += "com.apache.wedatasphere.linkis.engine.imexport.LoadData.loadDataToTable(spark,source,destination)"
    //    }else{
    //      newExecutionCode += "com.apache.wedatasphere.linkis.engine.imexport.LoadData.loadDataToTableByFile(spark,destination,source)"
    //    }
  }
