...
class JobHistoryDiagnosisServicelmpl extends JobHistoryDiagnosisService with Logging {
  ...
  override def insert(jobDiagnosis: JobDiagnosis): Unit = {
    jobDiagnosisMapper.insert(jobDiagnosis)
  }

  override def deleteById(id: lang.Long): Unit = {
    jobDiagnosisMapper.deleteById(id)
  }

  override def update(jobDiagnosis: JobDiagnosis): Unit = {
