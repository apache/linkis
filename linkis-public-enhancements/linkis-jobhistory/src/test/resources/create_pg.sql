...
CREATE SEQUENCE linkis_ps_job_history_detail_id_seq INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE;
CREATE SEQUENCE linkis_ps_job_history_group_history_id_seq INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE;

alter table linkis_ps_job_history_detail alter column id set default nextval('linkis_ps_job_history_detail_id_seq');
alter table linkis_ps_job_history_group_history alter column id set default nextval('linkis_ps_job_history_group_history_id_seq');
