...
public class ContextHistoryTypeTest {
  ...
  public void enumTest() {
    ...
    String typeName = ContextHistoryType.COMMON_CONTEXT_HISTORY_TYPE.getTypeName();

    Assertions.assertTrue(0 == index);
    Assertions.assertEquals("org.apache.linkis.cs.common.entity.source.CommonContextID", typeName);
  }
}
