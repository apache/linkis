...
public class ContextValueTypeTest {
  ...
  public void enumTest() {
    ...
    String commonTypeName = ContextValueType.COMMON_CONTEXT_VALUE_TYPE.getTypeName();

    Assertions.assertEquals(
        "org.apache.linkis.cs.common.entity.source.CommonContextValue", commonTypeName);
