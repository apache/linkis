...
class ConfigurationKeyEngineRelationMapperTest extends BaseDaoTest {
  ...
  @Autowired ConfigurationKeyEngineRelationMapper relationMapper;

  ConfigurationKeyEngineRelation insert() {
    ConfigurationKeyEngineRelation configurationKeyEngineRelation =
        new ConfigurationKeyEngineRelation();
