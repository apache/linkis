...
package com.apache.wedatasphere.linkis.jobhistory.conversions

import com.apache.wedatasphere.linkis.common.utils.{Logging, Utils}
import com.apache.wedatasphere.linkis.governance.common.entity.job.{JobRequest, SubJobDetail}
import com.apache.wedatasphere.linkis.governance.common.entity.task.{RequestPersistTask, RequestQueryTask}
import com.apache.wedatasphere.linkis.jobhistory.conf.JobhistoryConfiguration
import com.apache.wedatasphere.linkis.jobhistory.entity.{JobDetail, JobHistory, QueryTask, QueryTaskVO}
...
import com.apache.wedatasphere.linkis.server.{BDPJettyServerHelper, toScalaBuffer, toScalaMap}
