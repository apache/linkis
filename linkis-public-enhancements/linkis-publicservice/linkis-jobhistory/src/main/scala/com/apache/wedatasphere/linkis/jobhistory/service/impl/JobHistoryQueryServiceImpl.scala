...
package com.apache.wedatasphere.linkis.jobhistory.service.impl
...
import com.apache.wedatasphere.linkis.jobhistory.conversions.TaskConversions._
import com.apache.wedatasphere.linkis.jobhistory.dao.{JobDetailMapper, JobHistoryMapper}
import com.apache.wedatasphere.linkis.jobhistory.entity.JobHistory
import com.apache.wedatasphere.linkis.jobhistory.util.QueryUtils
...
import com.apache.wedatasphere.linkis.governance.common.constant.job.JobRequestConstants
import com.apache.wedatasphere.linkis.governance.common.entity.job.{JobRequest, JobRequestWithDetail, SubJobDetail}
import com.apache.wedatasphere.linkis.governance.common.protocol.job.{JobReqBatchUpdate, JobReqInsert, JobReqQuery, JobReqUpdate, JobRespProtocol}
import com.apache.wedatasphere.linkis.jobhistory.entity.QueryJobHistory
import com.apache.wedatasphere.linkis.jobhistory.exception.QueryException
import com.apache.wedatasphere.linkis.jobhistory.service.JobHistoryQueryService
import com.apache.wedatasphere.linkis.jobhistory.transitional.TaskStatus
...
//  private var queryCacheService: QueryCacheService = _
  ...
  /*private def queryTaskList2RequestPersistTaskList(queryTask: java.util.List[QueryTask]): java.util.List[RequestPersistTask] = {
    ...
    import com.apache.wedatasphere.linkis.jobhistory.conversions.TaskConversions.queryTask2RequestPersistTask
