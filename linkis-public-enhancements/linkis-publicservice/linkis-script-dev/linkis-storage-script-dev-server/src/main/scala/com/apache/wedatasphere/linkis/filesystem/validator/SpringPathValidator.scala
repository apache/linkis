...
package com.apache.wedatasphere.linkis.filesystem.validator

import java.io.File

import com.fasterxml.jackson.databind.JsonNode
import com.apache.wedatasphere.linkis.common.utils.Logging
import com.apache.wedatasphere.linkis.filesystem.conf.WorkSpaceConfiguration._
...
import com.apache.wedatasphere.linkis.server
import com.apache.wedatasphere.linkis.server.{Message, catchIt}
...
@Aspect
@Component
class SpringPathValidator extends Logging {

  @Pointcut("@annotation(org.springframework.web.bind.annotation.RequestMapping) && within(com.apache.wedatasphere.linkis.filesystem.restful.api.*)")
...
object SpringPathValidator {
  val validator = new SpringPathValidator()
