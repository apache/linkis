...
package com.apache.wedatasphere.linkis.variable.receiver

import com.apache.wedatasphere.linkis.protocol.variable.{RequestQueryAppVariable, RequestQueryGlobalVariable}
