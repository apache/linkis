...
abstract class AbstractAuthenticationAction(override val serverUrl: String)
    extends POSTAction
    with AuthenticationAction {
...
class DWSAuthenticationAction(override val serverUrl: String)
    extends AbstractAuthenticationAction(serverUrl)
    with DWSHttpAction {
