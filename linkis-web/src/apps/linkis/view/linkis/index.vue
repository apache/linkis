      ...
      <div class="content-body-side-nav">
        <Card
          ...
          <CellGroup
            ...
            <Cell
              v-if="!isLogAdmin? (item.path !=='/console/ECM')&&(item.path !=='/console/microService')&&(item.path !=='/console/tenantTagManagement')&&(item.path !=='/console/ipListManagement'):true"
              :key="index2"
    ...
    return {
      ...
      sideNavList: {
        ...
        children: [
          ...
          { key: '1-10', name: this.$t('message.linkis.sideNavList.function.children.tenantTagManagement'), path: '/console/tenantTagManagement' },
          { key: '1-11', name: this.$t('message.linkis.sideNavList.function.children.ipListManagement'), path: '/console/ipListManagement' },
        ],
      },
      urmSideNavList: {
        key: '1',
