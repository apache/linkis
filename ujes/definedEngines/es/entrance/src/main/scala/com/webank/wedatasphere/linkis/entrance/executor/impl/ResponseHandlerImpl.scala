...
import com.webank.wedatasphere.linkis.entrance.executor.ResponseHandler
import com.webank.wedatasphere.linkis.entrance.executor.ResponseHandler._
...
//          reader.readValue(contentBytes)
  ...
  def writeText(content: String, storePath: String, alias: String, proxyUser: String): String = {
    ...
    val writer = ResultSetWriter.getResultSetWriter(resultSet, EsEntranceConfiguration.ENGINE_RESULT_SET_MAX_CACHE.getValue.toLong, resultSetPath, proxyUser)
