...
import com.webank.wedatasphere.linkis.engine.flink.client.result.*;
...
public class SelectOperation extends AbstractJobOperation {
    ...
    public ResultSet execute() {
        ...
        return ResultSet.builder()
                ...
                .data(Row.of(jobId.toString(), applicationId, webInterfaceUrl))
                .build();
    }
    ...
    private <C> ResultDescriptor executeQueryInternal(ExecutionContext<C> executionContext, String query) {
        ...
        return executionContext.wrapClassLoader(
                () -> {
                    ...
                    this.jobId                    = jobClient.getJobID();
                    this.clusterDescriptorAdapter =
                            ClusterDescriptorAdapterFactory.create(context.getExecutionContext(), sessionId, this.jobId);
                    if (LOG.isDebugEnabled()) {
                        LOG.debug("Cluster Descriptor Adapter: {}", clusterDescriptorAdapter);
                    }

                    LOG.info("Session: {}. Submit flink job: {} successfully, query: {} ", sessionId, this.jobId.toString(), query);
    ...
    public void addResultListener(List<ResultListener> listenerList) {
        LOG.info("addResultListener {}",listenerList.size());
