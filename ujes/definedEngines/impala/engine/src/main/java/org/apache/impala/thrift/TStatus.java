...
public class TStatus implements org.apache.thrift.TBase<TStatus, TStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TStatus> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable org.apache.impala.thrift.TErrorCode status_code; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> error_msgs; // required
  ...
  public TStatus(
    ...
    java.util.List<java.lang.String> error_msgs)
  {
    this();
   ...
   * @see org.apache.impala.thrift.TErrorCode
   */
  public TStatus setStatus_code(@org.apache.thrift.annotation.Nullable org.apache.impala.thrift.TErrorCode status_code) {
    this.status_code = status_code;
    return this;
  }
  ...
  public int compareTo(TStatus other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetError_msgs()).compareTo(other.isSetError_msgs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetError_msgs()) {
