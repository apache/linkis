...
class PythonEngineCreator extends AbstractEngineCreator with Logging{
  override protected def createProcessEngineBuilder(): PythonSubmitProcessBuilder = {
  val pspb = new PythonSubmitProcessBuilder()
  pspb
}
}
