...
/**
  ...
  */
@EngineSchedulerContextBeanAnnotation
class EngineSchedulerContextImpl extends EngineSchedulerContext {
  @EngineExecutorManagerAutowiredAnnotation
  private var engineExecutorManager: EngineExecutorManager = _
  override def getOrCreateExecutorManager: EngineExecutorManager = engineExecutorManager
}