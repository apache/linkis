...
/**
  ...
  */
trait EngineHook {
  @throws[EngineManagerErrorException]
  def beforeCreateSession(requestEngine: RequestEngine): RequestEngine
  @throws[EngineManagerErrorException]
  def afterCreatedSession(engine: Engine, requestEngine: RequestEngine): Unit
