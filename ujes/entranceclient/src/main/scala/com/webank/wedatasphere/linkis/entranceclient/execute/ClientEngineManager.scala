...
/**
  ...
  */
class ClientEngineManager extends EngineManagerImpl with EngineApplicationNameFactory {

  override protected def getInstances: Array[ServiceInstance] = Sender.getInstances(getEngineApplicationName)
