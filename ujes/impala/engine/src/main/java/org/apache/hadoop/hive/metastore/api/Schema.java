...
public class Schema implements org.apache.thrift.TBase<Schema, Schema._Fields>, java.io.Serializable, Cloneable, Comparable<Schema> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<FieldSchema> fieldSchemas; // required
  ...
  public Schema setFieldSchemas(@org.apache.thrift.annotation.Nullable java.util.List<FieldSchema> fieldSchemas) {
    this.fieldSchemas = fieldSchemas;
    return this;
  }
  ...
  public Schema setProperties(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> properties) {
    this.properties = properties;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldSchemas = new java.util.ArrayList<FieldSchema>(_list0.size);
                @org.apache.thrift.annotation.Nullable FieldSchema _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new FieldSchema();
                  _elem1.read(iprot);
                  struct.fieldSchemas.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Schema struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldSchemas != null) {
        oprot.writeFieldBegin(FIELD_SCHEMAS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter7 : struct.fieldSchemas)
          {
            _iter7.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetFieldSchemas()) {
        {
          ...
          for (FieldSchema _iter9 : struct.fieldSchemas)
          {
            _iter9.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldSchemas = new java.util.ArrayList<FieldSchema>(_list11.size);
          @org.apache.thrift.annotation.Nullable FieldSchema _elem12;
          for (int _i13 = 0; _i13 < _list11.size; ++_i13)
          {
            _elem12 = new FieldSchema();
            _elem12.read(iprot);
            struct.fieldSchemas.add(_elem12);
          }
        }
        struct.setFieldSchemasIsSet(true);
      }
