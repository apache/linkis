...
public class TGetTablesReq implements org.apache.thrift.TBase<TGetTablesReq, TGetTablesReq._Fields>, java.io.Serializable, Cloneable, Comparable<TGetTablesReq> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> tableTypes; // optional
  ...
  public TGetTablesReq setSessionHandle(@org.apache.thrift.annotation.Nullable TSessionHandle sessionHandle) {
    this.sessionHandle = sessionHandle;
    return this;
  }
  ...
  public TGetTablesReq setCatalogName(@org.apache.thrift.annotation.Nullable java.lang.String catalogName) {
  ...
  public TGetTablesReq setSchemaName(@org.apache.thrift.annotation.Nullable java.lang.String schemaName) {
  ...
  public TGetTablesReq setTableName(@org.apache.thrift.annotation.Nullable java.lang.String tableName) {
  ...
  public TGetTablesReq setTableTypes(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> tableTypes) {
  ...
  public int compareTo(TGetTablesReq other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTableTypes()).compareTo(other.isSetTableTypes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTableTypes()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list172.size);
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter175 : struct.tableTypes)
            {
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (java.lang.String _iter176 : struct.tableTypes)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.tableTypes = new java.util.ArrayList<java.lang.String>(_list177.size);
