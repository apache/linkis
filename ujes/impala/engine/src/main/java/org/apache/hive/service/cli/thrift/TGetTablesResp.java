...
public class TGetTablesResp implements org.apache.thrift.TBase<TGetTablesResp, TGetTablesResp._Fields>, java.io.Serializable, Cloneable, Comparable<TGetTablesResp> {
  ...
  public TGetTablesResp setStatus(@org.apache.thrift.annotation.Nullable TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TGetTablesResp setOperationHandle(@org.apache.thrift.annotation.Nullable TOperationHandle operationHandle) {
