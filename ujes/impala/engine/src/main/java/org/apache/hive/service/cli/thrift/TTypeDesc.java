...
public class TTypeDesc implements org.apache.thrift.TBase<TTypeDesc, TTypeDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TTypeDesc> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TTypeEntry> types; // required
  ...
  public TTypeDesc setTypes(@org.apache.thrift.annotation.Nullable java.util.List<TTypeEntry> types) {
    this.types = types;
    return this;
  }
