...
public class TTypeEntry extends org.apache.thrift.TUnion<TTypeEntry, TTypeEntry._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.PRIMITIVE_ENTRY, new org.apache.thrift.meta_data.FieldMetaData("primitiveEntry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TPrimitiveTypeEntry.class)));
    tmpMap.put(_Fields.ARRAY_ENTRY, new org.apache.thrift.meta_data.FieldMetaData("arrayEntry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TArrayTypeEntry.class)));
    tmpMap.put(_Fields.MAP_ENTRY, new org.apache.thrift.meta_data.FieldMetaData("mapEntry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TMapTypeEntry.class)));
    tmpMap.put(_Fields.STRUCT_ENTRY, new org.apache.thrift.meta_data.FieldMetaData("structEntry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TStructTypeEntry.class)));
    tmpMap.put(_Fields.UNION_ENTRY, new org.apache.thrift.meta_data.FieldMetaData("unionEntry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TUnionTypeEntry.class)));
    tmpMap.put(_Fields.USER_DEFINED_TYPE_ENTRY, new org.apache.thrift.meta_data.FieldMetaData("userDefinedTypeEntry", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TTypeEntry(_Fields setField, java.lang.Object value) {
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case PRIMITIVE_ENTRY:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type TPrimitiveTypeEntry for field 'primitiveEntry', but got " + value.getClass().getSimpleName());
      case ARRAY_ENTRY:
        if (value instanceof TArrayTypeEntry) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TArrayTypeEntry for field 'arrayEntry', but got " + value.getClass().getSimpleName());
      case MAP_ENTRY:
        if (value instanceof TMapTypeEntry) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TMapTypeEntry for field 'mapEntry', but got " + value.getClass().getSimpleName());
      case STRUCT_ENTRY:
        if (value instanceof TStructTypeEntry) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TStructTypeEntry for field 'structEntry', but got " + value.getClass().getSimpleName());
      case UNION_ENTRY:
        if (value instanceof TUnionTypeEntry) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TUnionTypeEntry for field 'unionEntry', but got " + value.getClass().getSimpleName());
      case USER_DEFINED_TYPE_ENTRY:
        if (value instanceof TUserDefinedTypeEntry) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TUserDefinedTypeEntry for field 'userDefinedTypeEntry', but got " + value.getClass().getSimpleName());
      default:
  ...
  public TPrimitiveTypeEntry getPrimitiveEntry() {
    if (getSetField() == _Fields.PRIMITIVE_ENTRY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'primitiveEntry' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TArrayTypeEntry getArrayEntry() {
    if (getSetField() == _Fields.ARRAY_ENTRY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'arrayEntry' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TMapTypeEntry getMapEntry() {
    if (getSetField() == _Fields.MAP_ENTRY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'mapEntry' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TStructTypeEntry getStructEntry() {
    if (getSetField() == _Fields.STRUCT_ENTRY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'structEntry' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TUnionTypeEntry getUnionEntry() {
    if (getSetField() == _Fields.UNION_ENTRY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'unionEntry' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TUserDefinedTypeEntry getUserDefinedTypeEntry() {
    if (getSetField() == _Fields.USER_DEFINED_TYPE_ENTRY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'userDefinedTypeEntry' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
