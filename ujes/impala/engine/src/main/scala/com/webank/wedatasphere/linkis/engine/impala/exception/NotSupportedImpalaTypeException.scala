...
package com.webank.wedatasphere.linkis.engine.impala.exception
...
case class ImpalaSessionStartFailedException(erroCode:Int,
...
/**
  ...
  */
case class ImpalaQueryFailedException(erroCode:Int, desc:String) extends ErrorException(erroCode, desc){
